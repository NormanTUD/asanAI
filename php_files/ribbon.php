				...
				<div class="ribbon-toolbar" style="width:150px">
					<table>
						...
						<tr id="max_number_of_files_per_category_tr" class="hide_when_custom_data" style="display: none">
							...
							<td><input type="number" step=5 min="0" value="100" id="max_number_of_files_per_category" class="no_red_bg_when_empty" style="width: 40px"></td>
						</tr>
				...
				<table>
					<tr>
						<td colspan=2>
							...
							<button class="retrain_neural_network_button restart_training" style="min-width: 100%" onclick="retrain_neural_network()"><span class="TRANSLATEME_start_training_from_scratch"></span></button>
						</td>
					</tr>
					<tr>
						<td>
