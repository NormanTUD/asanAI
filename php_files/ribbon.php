<div id="ribbon" style="overflow: hidden;">
	<ul id="tablist">
		...
		<li><span id="custom_webcam_training_data_small" title="Start webcam for acquiring custom images" style="display: none" class="enabled_symbol only_when_webcam input_shape_is_image symbol_button" onclick="set_custom_webcam_training_data()"><img class="ribbon_icon" src="_gui/camera.svg" /></span></li>
