...
function memory_debugger () {
	...
	var debug_string = `<a target="_blank" href="https://scads.ai/imprint/">Impressum/Imprint</a>, Tensors: ` + colorize(num_tensors, tensor_color) + ", RAM: " + colorize(ram_mb, cpu_color) + "MB";
