	...
	for (var i in window) {
		if(
			![
				...
				"array_to_color",
				"contains_convolution",
				"typeassert",
				"array_to_fixed",
				"get_dec_points_math_mode",
				"a_times_b",
				"get_layer_output_shape_as_string",
				"_get_h",
				"get_right_side",
				"get_dec_points_math_mode",
				"get_optimizer_latex_equations",
				"get_loss_equations_string",
				"get_loss",
				"_temml",
				"get_values_for_optimizer_array_from_array",
				"last_shape_layer_warning",
				"get_input_shape",
				"stop_webcam_if_cam",
				"get_layer_right_offset",
				"divNoNan",
				"draw_bars_or_numbers",
				"show_bars_instead_of_numbers",
				"model_output_shape_looks_like_classification",
				"tensor_print_to_string",
				"tensor_print_to_string",
				"resizeNearestNeighbor",
				"resize_image",
				"insert_bias_initializers",
				"update_translations",
				"insert_initializer_options",
				"insert_initializer_option_trs",
				"add_bias_initializer_scale_option",
				"create_number_input_for_layer_panel_str",
				"is_touch_device",
				"get_cursor_or_none",
				"group_layers",
				"write_descriptions",
				...
				"get_stack_trace",
				"flatten",
				"annotate_output_neurons",
				"draw_neuron_with_normalized_color",
				"proper_layer_states_saved",
				"real_height",
				"parse_float",
				...
				"get_data_origin",
				"get_layer_classname_by_nr",
				"looks_like_number",
				"get_last_element_of_class_end_y",
				"add_waiting_symbol_to_content",
				"ribbon_shower_hack",
				"is_custom_data_and_has_custom_data",
				"get_fcnn_data",
				"get_item_value",
				"transform_array_whd_dwh",
				"get_shape_from_array",
				"_draw_layers_text",
				"_draw_neurons_or_conv2d",
				"_draw_neurons_and_connections",
				"add_started_training_symbol_to_content",
				"normalizeArray",
				"_draw_flatten",
				"draw_empty_kernel_rectangle",
				"any_trainable_checked",
				"normalizeArray",
				"draw_fcnn",
				"draw_first_layer_image",
				"get_last_description_of_layers_end_y",
				"add_model_is_trained_symbol_to_content",
				"draw_layer_neurons",
				"_register_tensors",
				"is_tf_tensor",
				"uuidv4",
...
async function send_bug_report () {
	...
	html += "<pre>" + JSON.stringify(global_model_data, null, 2) + "</pre>";
