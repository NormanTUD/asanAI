(function initValidationSplitGuard() {
  ...
  function showPopup() {
    ...
    // Hover pauses timer, leave resumes
  ...
  // Check on blur — user finished typing
  listen(maxFilesEl, "blur", function () {
    manualOverride = false;
    check();
  });

  // Also catch spinner arrows / arrow keys immediately
  listen(maxFilesEl, "change", function () {
    manualOverride = false;
    check();
  });

  // Val split manual edit → set override, close popup
