<div id="own_images_tab" class="tab">
	...
	<span>
		...
		<button class="buttons_in_custom_images" id="zip_upload_label" onclick="document.getElementById('zip_upload_input').click()"><img src="_gui/icons/zip.svg" height="15"> <span class="TRANSLATEME_upload_custom_zip_file" data-lang="en">Upload custom data from a .zip file</span></button>
		<input type="file" id="zip_upload_input" accept=".zip" style="display:none;" onchange="import_zip_and_replace_categories(this)">
