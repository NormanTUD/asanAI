	...
	<div class="container" id="predictcontainer">
		...
		<span id="own_files" class="no_autochoose_next_on_click">
			...
			<span id='webcam_tab' class="hide_when_no_image custom_image_data" style="padding-right: 50px; border-right: thin double rgb(0, 0, 0);">
				...
				<button style="display: none" class="only_when_front_and_back_camera" onclick="switch_to_next_camera_predict()"><img data-tr-alt="switch_camera" src="_gui/rotate_camera.svg" width=32 height=32><span class="TRANSLATEME_switch_to_other_cam"></span></button>
