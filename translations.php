<?php
	$GLOBALS['translations'] = array(
		'en' => array(
			...
			'separableConv2d_description' => 'This layer processes the input in two steps: first it looks at each part of the input separately to find patterns, and then it combines the results to create new information. The "depthMultiplier" argument controls how many outputs are produced per input part in the first step.',
		...
		'de' => array(
			...
			'separableConv2d_description' => 'Diese Schicht verarbeitet die Eingabe in zwei Schritten: Zuerst schaut sie sich jeden Teil der Eingabe einzeln an, um darin Muster zu erkennen, und danach kombiniert sie die Ergebnisse, um neue Informationen zu erzeugen. Das Argument „depthMultiplier“ bestimmt, wie viele Ergebnisse pro Eingabeteil im ersten Schritt erzeugt werden.',
