<?php
	$GLOBALS['translations'] = array(
		'en' => array(
			...
			'conv2d_description' => 'This layer looks at an image or other input and identifies important patterns, like edges, shapes, or textures. It processes the data step by step, combines it, and produces a new, condensed representation. Small details like <tt>useBias</tt> or <tt>activation</tt> tweak the results a bit, but the main idea is that the layer extracts what’s important. <div class="conv_visual_explanation"></div>',
		...
		'de' => array(
			...
			'conv2d_description' => 'Diese Schicht schaut sich ein Bild oder eine andere Eingabe an und erkennt darin wichtige Muster, wie Kanten, Formen oder Texturen. Sie verarbeitet die Daten Schritt für Schritt, kombiniert sie und erzeugt eine neue, zusammengefasste Darstellung. Kleine Details wie <tt>useBias</tt> oder <tt>activation</tt> verändern die Ergebnisse noch ein wenig, aber im Grunde geht es darum, dass die Schicht die wichtigen Merkmale herausarbeitet. <div class="conv_visual_explanation"></div>',
