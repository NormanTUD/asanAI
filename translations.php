<?php
	$GLOBALS['translations'] = array(
		'en' => array(
			...
			'program_looks_at_data' => 'The neural network now looks at the data repeatedly and tries to learn to categorize the images.',
			'the_further_on_top_the_better' => "<hr class='cosmo_hr'>The more images are correctly in the to the top blue area, the better the network learned.",
		...
		'de' => array(
			...
			'program_looks_at_data' => 'Das neuronale Netzwerk schaut sich jetzt alle diese Bilder immer wieder an und versucht zu lernen, sie zu kategorisieren.',
			'the_further_on_top_the_better' => "<hr class='cosmo_hr'>Umso mehr Bilder im oberen, blauen Bereich richtig eingeordnet sind, desto besser hat das Netzwerk gelernt.",
