<?php
	$GLOBALS['translations'] = array(
		'en' => array(
			...
			'flatten_description' => 'This layer turns a multi-dimensional input into a long list of values for each example, without changing the number of examples. You can think of it as "flattening" the data so that subsequent layers can handle it more easily. <div class="flatten_visual_explanation"></div>',
			'dropout_description' => 'Dropout consists in randomly setting a fraction of input units to 0 at each update during training time, which helps prevent overfitting. <div class="dropout_visual_explanation"></div>',
			...
			'averagePooling2d_description' => 'This layer looks at small regions of the input and computes the average value from each. You can think of it as summarizing the information in each area while making the data smaller and easier to handle. <div class="averagepooling_visual_explanation"></div>',
			...
			'maxPooling2d_description' => 'This layer looks at small regions of the input and keeps only the largest value from each. You can think of it as picking the most important information from an area while making the data smaller and easier to handle. <div class="maxpooling_visual_explanation"></div>',
		...
		'de' => array(
			...
			'dropout_description' => 'Dropout besteht darin, eine Bruchteilrate der Eingabeeinheiten während jeder Aktualisierung während der Trainingszeit zufällig auf 0 zu setzen, was Überanpassung verhindert. <div class="dropout_visual_explanation"></div>',
