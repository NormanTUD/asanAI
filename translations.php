<?php
	$GLOBALS['translations'] = array(
		'en' => array(
			...
			'dropout_description' => 'Dropout consists in randomly setting a fraction of input units to 0 at each update during training time, which helps prevent overfitting.',
