<?php
	$GLOBALS['translations'] = array(
		'en' => array(
			...
			"mv_tooltip_tensor_stats" => "Statistics of this tensor",
			"mv_tooltip_percentile" => "Percentile within this tensor",
			"mv_tooltip_map" => "Map of this tensor (outlined = hovered value)",
			"mv_tooltip_batch_hist" => "Distribution over the whole batch",
		...
		'de' => array(
			...
			"mv_tooltip_tensor_stats" => "Statistik dieses Tensors",
			"mv_tooltip_percentile" => "Perzentil innerhalb dieses Tensors",
			"mv_tooltip_map" => "Karte dieses Tensors (umrissen = überfahrener Wert)",
			"mv_tooltip_batch_hist" => "Verteilung über den ganzen Batch",
