<?php
	$GLOBALS['translations'] = array(
		'en' => array(
			...
			"pe_example_html_table_desc" => "Render a styled HTML table in the console",
			"pe_example_pixel_art" => "Pixel Art",
			"pe_example_pixel_art_desc" => "Draw pixel art on a tiny canvas, scaled up",
		...
		'de' => array(
			...
			"pe_example_html_table_desc" => "Eine gestylte HTML-Tabelle in der Konsole rendern",
			"pe_example_pixel_art" => "Pixel Art",
			"pe_example_pixel_art_desc" => "Pixel Art auf einem kleinen Canvas zeichnen, hochskaliert",
