<?php
	$GLOBALS['translations'] = array(
		'en' => array(
			...
			'conv2dTranspose_description' => 'This layer takes a small, condensed version of something, like an image, and makes it bigger again. You can imagine it "unrolling" or "stretching" the information to create a shape that roughly looks like the original.',
		...
		'de' => array(
			...
			"snake_description" => "Snake-Aktivierung.<br>Diese Funktion transformiert die Eingabe wie folgt, wobei <span class='temml_me'>\alpha</span> ein lernbarer Parameter ist:<br><span class='temml_me'>f(x) = x + \\frac{\\sin^2(x)}{\\alpha}</span> <div class='activation_visual_explanation snake visual_explanations'></div> <div class='activation_visual_explanation snake visual_explanations'></div>",
			...
			'conv2dTranspose_description' => 'Diese Schicht nimmt eine kleine, zusammengefasste Version von etwas, z. B. einem Bild, und macht daraus wieder etwas Größeres. Man kann sich vorstellen, dass sie die Infos „ausrollt“ oder „streckt“, damit wieder eine Form entsteht, die ungefähr wie das Original aussieht.',
