<?php
	$GLOBALS['translations'] = array(
		'en' => array(
			...
			"snake_description" => "Snake activation.<br>This function transforms the input as follows, where <span class='temml_me'>\alpha</span> is a learnable parameter:<br><span class='temml_me'>f(x) = \\beta \\cdot \left(x + \\frac{\\sin^2(x)}{\\alpha}\\right)</span>",
		...
		'de' => array(
			...
			"snake_description" => "Snake-Aktivierung.<br>Diese Funktion transformiert die Eingabe wie folgt, wobei <span class='temml_me'>\alpha</span> ein lernbarer Parameter ist:<br><span class='temml_me'>f(x) = \\beta \\cdot \left(x + \\frac{\\sin^2(x)}{\\alpha}\\right)</span>",
