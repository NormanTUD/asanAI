<?php
	$GLOBALS['translations'] = array(
		'en' => array(
			...
			"gaussianNoise_description" => "Adds Gaussian noise to the input.<br>This means small random variations are added to the input values, making the model more resistant to noisy or imperfect data.<br>As a regularization layer, it is only active during training.",
		...
		'de' => array(
			...
			"gaussianNoise_description" => "Fügt gaußsches Rauschen zur Eingabe hinzu.<br>Das bedeutet, dass kleine zufällige Abweichungen zu den Eingabewerten addiert werden. Dadurch lernt das Modell, auch mit verrauschten oder unvollständigen Daten umzugehen.<br>Da es sich um eine Regularisierungsschicht handelt, ist sie nur während des Trainings aktiv.",
