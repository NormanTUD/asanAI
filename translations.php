<?php
	$GLOBALS['translations'] = array(
		'en' => array(
			...
			'conv2d_description' => 'This layer looks at an image or other input and identifies important patterns, like edges, shapes, or textures. It processes the data step by step, combines it, and produces a new, condensed representation. Small details like <tt>useBias</tt> or <tt>activation</tt> tweak the results a bit, but the main idea is that the layer extracts what’s important.',
