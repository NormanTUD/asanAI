<?php
	$GLOBALS['translations'] = array(
		...
		'de' => array(
			...
			'we_want_to_train_this_model_5_categories' => 'Wir wollen dieses Model trainieren, um 5 Kategorien von Zeichen zu unterscheiden:',
			'fire' => 'Feuer',
			'mandatory' => 'Verpflichtend',
			'forbidden' => 'Verbot',
			'rescue' => 'Rettung',
			'warning' => 'Warnung',
			'the_more_variations_the_model_sees' => 'Je mehr Variationen das Model sieht, desto besser kann es die wichtigsten Merkmale der Bilder lernen.',
			...
			'model_visualization' => 'Modelvisualisierung',
			'data' => 'Daten',
			...
			'not_creating_model_because_values_are_missing' => 'Kann Model nicht erstellen, weil Werte fehlen',
			'tensors' => 'Tensoren',
			...
			"model_is_not_defined" => "Model ist nicht definiert",
			"model_is_ok" => "Model ist OK",
