<?php
	$GLOBALS['translations'] = array(
		'en' => array(
			...
			'averagePooling2d_description' => 'This layer looks at small regions of the input and computes the average value from each. You can think of it as summarizing the information in each area while making the data smaller and easier to handle.',
