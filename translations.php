<?php
	$GLOBALS['translations'] = array(
		'en' => array(
			...
			'depthwiseConv2d_description' => 'This layer looks at each part of the input separately and searches for patterns like edges or shapes. You can imagine it "examining" each part on its own before combining the results to keep the most important information. The "depthMultiplier" argument controls how many outputs are produced per input part.',
