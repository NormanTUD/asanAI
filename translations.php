<?php
	$GLOBALS['translations'] = array(
		'en' => array(
			...
			'reLU_description' => 'Rectified Linear Unit activation function. <span class="temml_me">\\mathrm{relu}\\left(x\\right) = \\mathrm{max}\\left(0, x\\right)</span>',
		...
		'de' => array(
			...
			'reLU_description' => 'Aktivierungsfunktion der rektifizierten linearen Einheit. <span class="temml_me">\\mathrm{relu}\\left(x\\right) = \\mathrm{max}\\left(0, x\\right)</span>',
