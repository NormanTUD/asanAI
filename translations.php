<?php
	$GLOBALS['translations'] = array(
		...
		// Decision Explorer
		"dex_tab_label" => "Decision Explorer",
		"dex_title" => "Decision Explorer",
		"dex_subtitle" => "Trace how a single input flows through every layer of the network and see which neurons drive the prediction",
		"dex_input" => "Input",
		"dex_sample" => "Sample",
		"dex_prediction" => "Prediction",
		"dex_confidence" => "Confidence",
		"dex_layers" => "Layers",
		"dex_parameters" => "Parameters",
		"dex_neuron" => "Neuron",
		"dex_sum" => "Σ|a|",
		"dex_correct" => "Correct!",
		"dex_wrong" => "Wrong!",
		"dex_actual_was" => "Actual:",
		"dex_unknown" => "unknown",
		"dex_hurts" => "hurts",
		"dex_helps" => "helps",
		"dex_no_model" => "No model loaded. Please create or load a model first.",
		"dex_no_data" => "No data available. Load a dataset or train first.",
		"dex_computing" => "Computing decision trace...",
		"dex_error" => "An error occurred while computing the decision trace.",
		"dex_flow_title" => "Information Flow",
		"dex_flow_explain" => "This diagram shows how data flows through each layer. The width of each connection reflects the total activation magnitude &mdash; wider means more information passes through.",
		"dex_neuron_title" => "Neuron Contributions",
		"dex_neuron_explain" => "For each layer, the most active neurons are shown. Green bars indicate positive activations, red bars indicate negative activations. The longer the bar, the stronger the contribution.",
		"dex_attr_title" => "Input Attribution",
		"dex_attr_explain" => "This shows which parts of the original input had the most influence on the final prediction. Green = helped the predicted class, red = worked against it.",
		"dex_explain_title" => "What does this mean?",
		"dex_beginner" => "Beginner",
		"dex_advanced" => "Advanced",
		"dex_beginner_intro" => "Let's follow how your neural network made its decision for this input:",
		"dex_beginner_prediction" => "The network predicted <strong>",
		"dex_beginner_journey" => "The data traveled through <strong>",
		"dex_beginner_early" => "In the early layers, the network detected simple patterns. ",
		"dex_beginner_active" => "Most neurons are active (",
		"dex_beginner_active2" => ") - the network is using a broad set of features.",
		"dex_beginner_sparse" => "Only a few neurons are active (",
		"dex_beginner_sparse2" => ") - the network is being very selective about what it pays attention to.",
		"dex_beginner_final" => "In the final layer, neuron <strong>",
		"dex_beginner_final2" => "</strong> had the strongest activation. This neuron's output is what ultimately determines the prediction.",
		"dex_beginner_attribution_image" => "The heatmap above shows which pixels influenced the decision most. Bright green = helped the prediction, red = worked against it.",
		"dex_beginner_attribution_tabular" => "The feature importance bars above show which input features had the most influence on the decision. Green = positive influence, red = negative.",
		"dex_adv_decision_trace" => "Decision Trace",
		"dex_adv_for_sample" => "for sample",
		"dex_adv_prediction" => "Prediction: <strong>",
		"dex_adv_true" => "True: ",
		"dex_adv_params" => "Total parameters",
		"dex_adv_layers" => "Layers",
		"dex_adv_compressing" => "compressing",
		"dex_adv_expanding" => "expanding",
		"dex_adv_ig_title" => "<strong>Integrated Gradients Attribution</strong>",
		"dex_adv_ig_explain" => "Attribution computed via Integrated Gradients with 20 interpolation steps between a zero baseline and the input. The attribution at each pixel is the integral of gradients along the straight-line path, multiplied by the input value. This satisfies the completeness axiom: the sum of attributions equals the difference between the prediction at the input and the prediction at the baseline.",
		"dex_adv_feat_title" => "<strong>Feature Attribution</strong>",
		"dex_adv_feat_explain" => "Per-feature importance computed as the average gradient of the target class output with respect to each input feature, scaled by the feature value. Green bars indicate features that pushed the prediction toward the predicted class; red bars indicate features that pushed against it.",
		"dex_adv_dead_relu" => "Potential dying ReLU detected at layer",
		"dex_adv_high_sparsity" => "High sparsity at layer",
		...
		'de' => array(
			...
			// Decision Explorer
			"dex_tab_label" => "Entscheidungsexplorer",
			"dex_title" => "Entscheidungsexplorer",
			"dex_subtitle" => "Verfolge, wie ein einzelner Input durch jeden Layer des Netzwerks fliesst und sieh, welche Neuronen die Vorhersage steuern",
			"dex_input" => "Eingabe",
			"dex_sample" => "Beispiel",
			"dex_prediction" => "Vorhersage",
			"dex_confidence" => "Konfidenz",
			"dex_layers" => "Layer",
			"dex_parameters" => "Parameter",
			"dex_neuron" => "Neuron",
			"dex_sum" => "Σ|a|",
			"dex_correct" => "Richtig!",
			"dex_wrong" => "Falsch!",
			"dex_actual_was" => "Tatsächlich:",
			"dex_unknown" => "unbekannt",
			"dex_hurts" => "schadet",
			"dex_helps" => "hilft",
			"dex_no_model" => "Kein Modell geladen. Bitte erstelle oder lade zuerst ein Modell.",
			"dex_no_data" => "Keine Daten verfügbar. Lade einen Datensatz oder starte das Training.",
			"dex_computing" => "Berechne Entscheidungsspur...",
			"dex_error" => "Beim Berechnen der Entscheidungsspur ist ein Fehler aufgetreten.",
			"dex_flow_title" => "Informationsfluss",
			"dex_flow_explain" => "Dieses Diagramm zeigt, wie Daten durch jeden Layer fliessen. Die Breite jeder Verbindung spiegelt die Gesamtaktivierung wider &mdash; breiter bedeutet, dass mehr Information fliesst.",
			"dex_neuron_title" => "Neuronen-Beiträge",
			"dex_neuron_explain" => "Für jeden Layer werden die aktivsten Neuronen angezeigt. Grüne Balken zeigen positive Aktivierungen, rote negative. Je länger der Balken, desto stärker der Beitrag.",
			"dex_attr_title" => "Input-Zuschreibung",
			"dex_attr_explain" => "Zeigt, welche Teile des Eingabewerts den stärksten Einfluss auf die finale Vorhersage hatten. Grün = unterstützte die Vorhersage, rot = wirkte dagegen.",
			"dex_explain_title" => "Was bedeutet das?",
			"dex_beginner" => "Anfänger",
			"dex_advanced" => "Experte",
			"dex_beginner_intro" => "Lass uns verfolgen, wie dein neuronales Netzwerk diese Entscheidung getroffen hat:",
			"dex_beginner_prediction" => "Das Netzwerk hat <strong>",
			"dex_beginner_journey" => "Die Daten reisten durch <strong>",
			"dex_beginner_early" => "In den frühen Schichten hat das Netzwerk einfache Muster erkannt. ",
			"dex_beginner_active" => "Die meisten Neuronen sind aktiv (",
			"dex_beginner_active2" => ") &mdash; das Netzwerk nutzt ein breites Spektrum an Merkmalen.",
			"dex_beginner_sparse" => "Nur wenige Neuronen sind aktiv (",
			"dex_beginner_sparse2" => ") &mdash; das Netzwerk ist sehr selektiv bei dem, wofür es sich interessiert.",
			"dex_beginner_final" => "In der letzten Schicht hatte Neuron <strong>",
			"dex_beginner_final2" => "</strong> die stärkste Aktivierung. Die Ausgabe dieses Neuron bestimmt letztlich die Vorhersage.",
			"dex_beginner_attribution_image" => "Die Heatmap oben zeigt, welche Pixel die Entscheidung am stärksten beeinflusst haben. Helles Grün = unterstützte die Vorhersage, Rot = wirkte dagegen.",
			"dex_beginner_attribution_tabular" => "Die Merkmalswichtigkeits-Balken oben zeigen, welche Eingabemerkmale den grössten Einfluss auf die Entscheidung hatten. Grün = positiver Einfluss, Rot = negativer Einfluss.",
			"dex_adv_decision_trace" => "Entscheidungsspur",
			"dex_adv_for_sample" => "für Beispiel",
			"dex_adv_prediction" => "Vorhersage: <strong>",
			"dex_adv_true" => "Tatsächlich: ",
			"dex_adv_params" => "Gesamtparameter",
			"dex_adv_layers" => "Layer",
			"dex_adv_compressing" => "komprimiert",
			"dex_adv_expanding" => "erweitert",
			"dex_adv_ig_title" => "<strong>Integrierte Gradienten-Zuschreibung</strong>",
			"dex_adv_ig_explain" => "Zuschreibung berechnet mittels Integrierte Gradienten mit 20 Interpolationsschritten zwischen einer Null-Baseline und dem Input. Die Zuschreibung an jedem Pixel ist das Integral der Gradienten entlang des geraden Pfads, multipliziert mit dem Input-Wert. Dies erfüllt das Vollständigkeitsaxiom: Die Summe der Zuschreibungen entspricht der Differenz zwischen der Vorhersage beim Input und der Vorhersage bei der Baseline.",
			"dex_adv_feat_title" => "<strong>Merkmals-Zuschreibung</strong>",
			"dex_adv_feat_explain" => "Merkmalswichtigkeit berechnet als den durchschnittlichen Gradienten der Zielklassen-Ausgabe bezüglich jedes Eingabemerkmals, skaliert mit dem Merkmalswert. Grüne Balken zeigen Merkmale, die die Vorhersage in Richtung der vorhergesagten Klasse verschieben; rote Balken zeigen Merkmale, die dagegen wirken.",
			"dex_adv_dead_relu" => "Möglicher sterbender ReLU erkannt in Layer",
			"dex_adv_high_sparsity" => "Hohe Spärlichkeit in Layer",
