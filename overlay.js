...
function _apply_overlay_background(overlay, bg_color) {
...
function _create_overlay_progress_bar(contentWrapper, overlay) {
...
function show_overlay(text, title="", options={}) {
	...
	try {
		...
		var show_progress = options.progress || false;
		...
		if (show_progress) {
			_create_overlay_progress_bar(contentWrapper, overlay);
		}
