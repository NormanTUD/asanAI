    ...
    _draw:function () {
        ...
        for (var i = 0; i < this._overlays.length; i++) {
            if (i < images.length) {
                ...
                this._overlays[i].css({'background-position':bg, 'display':'block', "z-index": 99999, "position": "absolute"});
            }
            else {
...
clippy.Balloon.prototype = {
	...
	_setup:function () {
		...
		this._balloon = $('<div class="clippy-balloon bubble"><div class="clippy-tip"></div><div class="clippy-content"></div></div> ').hide();
