...
Usage:
  ./find_long_functions                 # scans *.js in cwd
  ./find_long_functions file1.js a.js   # scan these files
  ./find_long_functions --min-lines 50
  ./find_long_functions --max-lines 500   # exits non-zero if any function > 500 lines
"""
...
ignored_long_funcs = [
    ...
    "_get_run_sh_file_for_custom_training",
    "_get_predict_py_for_local_training",
    "run_tests",
    "create_python_code",
    "check_if_lang",
...
def default_files_from_cwd() -> List[str]:
    return sorted(f for f in glob.glob("*.js") if f not in ignored_files)
