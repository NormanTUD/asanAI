...
ignored_files = ["asanai.js", "manual.js", "python_code.js", "activation_atlas.js", "trace_through_loss_landscape.js", "topological_analyzer.js", "optimizer_info.js", "initializer_info.js", "explain_activations.js"]
ignored_file_funcs = [
    "main.js:fire",
    "gui.js:fire",
    "model.js:traindebug",
    ...
    "data.js:predict",
    "gui.js:predict",
    "weight_surfaces.js:random",
    "gui.js:assert",
    "variables.js:get_tr_str_for_layer_table",
    "gui.js:load_model",
    "explain.js:predict",
    "explain.js:assert",
    "data.js:fire",
    ...
    "easter_eggs.js:fire",
    "plot_predict.js:update_plot",
    "plot_predict.js:hide_plot",
    "weight_surfaces.js:_plot_preserve_camera",
...
def extract_function_defs(content):
    ...
    for lineno, line in enumerate(lines, start=1):
        for m in pattern.finditer(line):
            ...
            defs[name] = (min_args, max_args, lineno, line.strip())
    return defs
...
def remove_strings(code):
    result, in_str, esc = "", None, False
    for ch in code:
        if esc:
            result += " "  # keep length same-ish
            esc = False
            continue
        if ch == "\\":
            esc = True
...
def check_files(files):
    ...
    for f in files:
        ...
        for name, v in defs.items():
            all_defs[name] = (v[0], v[1], f, v[2], v[3])  # add file + lineno + line
    r = 0
