...
function add_new_category() {
	...
	if (imgDiv.length == 0 || imgDiv.length <= n) {
		...
		$(
			...
			'<div id="' + uuid + '"></div>' +
			`<button onclick="add_image_to_category($('#${uuid}_sketcher')[0].toDataURL(), ${label_nr});event.preventDefault();atrament_data['${uuid}_sketcher']['atrament'].clear();">Save this image</button>`
...
function get_drawing_board_on_page (indiv, idname, customfunc) {
	...
	var code = `<form>
		<a class='atrament_buttons invert_in_dark_mode' onclick="atrament_data['${idname}']['atrament'].mode = 'brush'; $('.relevant_for_pen').show();"><img width=32 src='pen.png'/></a>
		<a class='atrament_buttons invert_in_dark_mode' onclick="atrament_data['${idname}']['atrament'].mode = 'fill'; $('.relevant_for_pen').show();"><img width=32 src='Fill-icon.svg'></a>
		<a class='atrament_buttons invert_in_dark_mode' onclick="atrament_data['${idname}']['atrament'].mode = 'erase'; $('.relevant_for_pen').hide();"><img width=32 src='Eraser_icon.svg'/></a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<input class="show_data relevant_for_pen" type="range" min="1" oninput="atrament_data['${idname}']['atrament'].weight = parseFloat(event.target.value);" value="2" step="0.1" autocomplete="off" />
		<br />
	</form>
