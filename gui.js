...
function add_new_category() {
	...
	if (imgDiv.length == 0 || imgDiv.length <= n) {
		$('<div class="own_image_upload_container"><hr><button class="webcam_data" onclick="take_image_from_webcam(this)">&#128248; Take image from webcam</button><button class="delete_category_button" onclick="delete_category(this)">Delete this category</button></div>').appendTo("#own_images_container");
