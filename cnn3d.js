...
(function (global) {
	...
	function ensureGUI(inst) {
		...
		gui.innerHTML = ''
			...
			+ '      </select>'
			+ '    </label>'
			+ '    <label data-tip="Toggle the drawing of lines between consecutive layers." style="display:block;margin:6px 0;"><input type="checkbox" class="show_data" data-role="sc" checked> Show weighted connections</label>'
