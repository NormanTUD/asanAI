...
# echo "digraph a {" > cleaned.dot; cat test.dot | grep -v swal | grep -v sweet | grep -v run_tests | grep -v jscolor | grep -v eval | grep -v Promise | grep -v AlexNet | grep -v LeNet | grep -v FCNN | grep -v Fireworks | grep -v FilterUtils | grep -v EventListener | grep -v restart_alexnet | grep -v restart_lenet | grep -v restart_fcnn | sort | uniq | grep -v digraph | grep -v '^\s*}\s*$' | wc -l >> cleaned.dot; wc -l cleaned.dot; dot -Tsvg cleaned.dot > a.svg; gwenview a.svg
...
-->
				...
				<div class="cosmo_next_button_span" style="display: none; position: absolute; top: 150px; right: 10em; font-size: 1em; width: 150px;">
					<span 
