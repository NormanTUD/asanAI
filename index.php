...
?>
				...
				<div id="toggle_layers_button" data-rotated="1" data-required_skills="finished_training[2]" class="cosmo"><button style="width: 100%" onclick="toggle_layers()">&#9881;&#129302;</button></div>
