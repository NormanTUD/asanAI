	...
	<body data-chardin-sequenced="true">
		...
		<div id="mainsite">
			<div id="ribbon_shower">
				...
				<span id="custom_webcam_training_data" class="manicule_wave_1 show_cosmo_wave_1" style="display: none" class="only_when_webcam input_shape_is_image symbol_button show_cosmo_wave_2" data-mfb="1" onclick="set_custom_webcam_training_data()">&#128248;</span>
				<span id="start_stop_training" class="manicule_wave_0 symbol_button show_cosmo_wave_0 manicule_wave_3" onclick="train_neural_network()">&#127947;</span>
			</div>
			<div id="ribbon" style="overflow: hidden;">
				<ul id="tablist">
					...
					<li><span id="custom_webcam_training_data_small" style="display: none" class="only_when_webcam input_shape_is_image symbol_button show_cosmo_wave_3" onclick="set_custom_webcam_training_data()">&#128248;</span></li>
...
?>
				...
				<div id="toggle_layers_button" class="show_cosmo_wave_4"><button style="width: 100%" onclick="toggle_layers()"><span class="large_button">&#9881;&#129302;</span></button></div>
	...
	write_file_for_tfjs("y", y_train)	# Writes y.txt with y-data</code></pre>
							...
							<div id="own_image_data">
								...
								<div class='webcam_data only_when_webcam hide_in_cosmo_mode'>
									Number of images in a series: <input type='number' min=1 value='20' id='number_of_series_images' onchange="alter_text_webcam_series()" /><br>
