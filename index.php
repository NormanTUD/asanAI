	...
	<body data-chardin-sequenced="true">
		...
		<div id="mainsite">
			<div id="ribbon_shower">
				...
				<span id="custom_webcam_training_data" style="display: none" class="only_when_webcam input_shape_is_image symbol_button show_cosmo_wave_2 manicule_wave_2" data-rotated="1" onclick="set_custom_webcam_training_data()">&#128248;</span>
