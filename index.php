	...
	<body data-chardin-sequenced="true">
		...
		<div id="mainsite">
			<div id="ribbon_shower">
				...
				<span id="start_stop_training" class="manicule_wave_0 symbol_button show_cosmo_wave_0" onclick="train_neural_network()">&#127947;</span>
			</div>
...
?>
				...
				<div id="toggle_layers_button" class="show_cosmo_wave_3"><button style="width: 100%" onclick="toggle_layers()"><span class="large_button">&#9881;&#129302;</span></button></div>
