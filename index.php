							...
							<div id="predict_tab">
								...
								<div class="container" id="predictcontainer">
									<div class="show_only_in_cosmo_mode">
										<button class="cosmo" data-required_skills="loaded_page[1],watched_presentation[1],finished_training[1]" id="webcam_in_cosmo" onclick="switch_predict_mode()">Kamera 📷</button>
									</div>
