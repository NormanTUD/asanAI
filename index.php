	...
	<body data-chardin-sequenced="true">
		...
		<div id="mainsite">
			<div id="ribbon_shower">
				...
				<span id="start_stop_training" class="manicule_wave_0 symbol_button show_cosmo_wave_0 manicule_wave_6" onclick="train_neural_network();increase_cosmo_wave_when_clicked_element_is_maniculed(this)">&#127947;</span>
			</div>
