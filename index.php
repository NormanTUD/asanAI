	...
	<body data-chardin-sequenced="true">
		...
		<div id="mainsite">
			<div id="ribbon_shower">
				...
				<span id="start_stop_training" data-required_skills="" data-show_again_when_new_skill_acquired="took_webcam_photo" class="cosmo symbol_button" onclick="train_neural_network();">&#127947;</span>
			</div>
