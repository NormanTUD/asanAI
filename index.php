	...
	<body data-chardin-sequenced="true">
		...
		<div id="mainsite">
			<div id="ribbon_shower">
				...
				<span id="start_stop_training" data-keep_cosmo="1" data-required_skills="loaded_page" data-show_again_when_new_skill_acquired="took_images[2]" class="cosmo symbol_button" onclick="remove_manicule();train_neural_network();$('#start_stop_training').attr('data-clicked', '1');">&#127947;</span>
			</div>
