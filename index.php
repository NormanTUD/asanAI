	...
	<body data-chardin-sequenced="true">
		...
		<div id="mainsite">
			<div id="ribbon_shower">
				...
				<span id="custom_webcam_training_data" style="display: none" data-required_skills="finished_training" class="cosmo only_when_webcam input_shape_is_image symbol_button" data-rotated="1" onclick="set_custom_webcam_training_data()">&#128248;</span>
				<span id="start_stop_training" data-keep_cosmo="1" data-required_skills="" data-show_again_when_new_skill_acquired="took_webcam_photo" class="cosmo symbol_button" onclick="train_neural_network();">&#127947;</span>
			</div>
