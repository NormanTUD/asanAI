(function () {
  ...
  css.textContent = [
    ...
    "  gap: 0; margin: 28px 0; padding: 18px;",
    ...
    ".wslab-arch-icon {",
    "  font-size: 1.5em; text-align: center; line-height: 1;",
    "  width: 52px; height: 52px; display: flex; align-items: center; justify-content: center;",
    "  background: var(--mn-bg-subtle); border-radius: 10px;",
    "  border: 1px solid var(--mn-border);",
    "}",
    ".wslab-arch-title {",
    "  font-weight: 700; font-size: 0.95em; color: var(--mn-heading);",
    "  margin-bottom: 3px;",
    "}",
    ".wslab-arch-desc {",
    "  font-size: 0.85em; color: var(--mn-text-secondary); line-height: 1.5;",
    "}",
    ".wslab-arch-step--user       { border-left-color: #3b82f6; }",
    ".wslab-arch-step--user       .wslab-arch-icon { background: rgba(59,130,246,0.15); }",
    ".wslab-arch-step--orchestrator { border-left-color: #8b5cf6; }",
    ".wslab-arch-step--orchestrator .wslab-arch-icon { background: rgba(139,92,246,0.15); }",
    ".wslab-arch-step--search     { border-left-color: #06b6d4; }",
    ".wslab-arch-step--search     .wslab-arch-icon { background: rgba(6,182,212,0.15); }",
    ".wslab-arch-step--fetch      { border-left-color: #10b981; }",
    ".wslab-arch-step--fetch      .wslab-arch-icon { background: rgba(16,185,129,0.15); }",
    ".wslab-arch-step--extract    { border-left-color: #eab308; }",
    ".wslab-arch-step--extract    .wslab-arch-icon { background: rgba(234,179,8,0.15); }",
    ".wslab-arch-step--chunk      { border-left-color: #f97316; }",
    ".wslab-arch-step--chunk      .wslab-arch-icon { background: rgba(249,115,22,0.15); }",
    ".wslab-arch-step--prompt     { border-left-color: #ef4444; }",
    ".wslab-arch-step--prompt     .wslab-arch-icon { background: rgba(239,68,68,0.15); }",
    ".wslab-arch-step--llm        { border-left-color: #6366f1; }",
    ".wslab-arch-step--llm        .wslab-arch-icon { background: rgba(99,102,241,0.15); }",
    ".wslab-arch-step--answer     { border-left-color: #059669; }",
