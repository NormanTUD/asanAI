...
* **RoPE scaling** (Su et al., 2021): interpolate or extrapolate rotary position embeddings. **YaRN** (Peng et al., 2023) extends this with frequency-aware scaling.
...
* **Math-Shepherd** (Zhang et al., 2024): auto-labels step correctness by checking if subsequent steps can reach the answer.
...
Related: **early exit** (Elhoushi et al., 2024), **conditional computation** (Fedus et al., 2022), **Skrr** (skip-routing, Sakurai et al., 2024).
</div>
...
* **Dreamer V3** (Hafner et al., 2023): world model enables Minecraft diamond collection from scratch.
...
* **Causal scrubbing** (Redman et al., 2024): formally verify which circuits implement a behavior.
