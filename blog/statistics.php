...
<figure>
    ...
    <figcaption class="md">Illustration in the paper \citetitle{ceresdiscovery}, which first described the back-then newly discovered dwarf-planet Ceres</figcaption>
</figure>
...
<div class="statlab-section">
    <div class="md">
        ...
        Popularized by **Sir \citeauthor{fisher1922}** in *\citetitle{fisher1922}* (\citeauthor{fisher1922}), MLE was created to solve the problem of **Parameter Estimation**. If you see 10 tall people, what is the "most likely" average height of the whole population?
