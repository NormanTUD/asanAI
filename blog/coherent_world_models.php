...
But there is a rare and uncomfortable limit case. When we discuss qualia and *experience the very same qualia* while discussing them, the trace and the topic collapse: the experience we are tracking is the experience we are having. This is the closest thing the framework admits to an unmediated datum, and it is precisely where direct realism reasserts itself. Even here the collapse is partial: as soon as the experience enters *language*, it is re-mediated by conceptual scheme, by contrast-class, by the public vocabulary of colour ("red" already presupposes a contrast with green, yellow, blue). Languageless introspection — if such a thing exists at all — would be the limit where trace and topic are most nearly identical, and where the framework has least to say.

The framework takes the indirect-realist / representationalist side as its *default*: there is a subject matter distinct from access, and a thing-in-itself distinct from any appearance. A philosopher who holds qualia to be primary — for whom the redness *is* the world's redness, not a brain construction — will not share this default; they will say the framework has mis-described the limit case. The dispute is *foundational*: it cannot be settled inside the framework, only acknowledged at the door. Inside the framework's default, there is no Archimedean point from which the world shows itself untransformed. Kant's name for what is forever on the other side of this mediation is the *thing in itself* (*Ding an sich*) — first introduced in the *Critique of Pure Reason* at KrV A26/B42 (§3 of Space, in the Transcendental Aesthetic) and developed systematically in the chapter "Of Phenomena and Noumena" at A235/B294 \cite{kant_critique_pure_reason}; the technical term here is **the subject matter as it would be independent of any access**. We never get there. The right question is therefore not "how do we reach it?" but "what can we honestly do with the traces we have?"
