...
The first three break-points, located on the one diagram (the fourth — the calibrated error — has no single spot to mark: its failure is a bias spread across *passing* contact points, not a missing link):
