...
Please report errros to <a href="mailto:<?php echo hide_email('norman.koch@tu-dresden.de'); ?>">my email</a>. I try my best to keep this site as factual as possible, but I may get things wrong or incomplete, and thus am happy to get any feedback.
