...
This picture has been confirmed in pieces by ROME-style edits \cite{meng2022locating} \cite{meng2022memit}, knowledge-neuron attributions \cite{dai2022knowledgeneurons}, function-vector steering \cite{todd2024functionvectors}, induction-head analysis \cite{olsson2022induction}, logit-lens inspection \cite{nostalgebraist2020logitlens} \cite{belrose2023tunedlens}, and superposition-aware feature extraction \cite{elhage2022superposition} \cite{cunningham2023sparse} \cite{bricken2023monosemanticity} \cite{templeton2024scaling} \cite{elhage2022solu}. Anthropic's interpretability blog — "Mapping the mind of a large language model" \cite{anthropic2023mapping} being the early accessible summary, with the full machinery developed in the Transformer Circuits Thread series \cite[Elhage et al., 2021]{elhage2021mathematical} \cite{olsson2022induction} \cite{elhage2022superposition} \cite{bricken2023monosemanticity} \cite{templeton2024scaling} \cite{ameisen2025circuit} \cite{lindsey2025biology} — has driven most of this story since 2021. The picture is also consistent with the Hopfield-network interpretation of attention \cite{ramsauer2020hopfield} \cite{hopfield1982}. It is not yet, however, the whole picture for frontier-scale models or multi-hop reasoning.
