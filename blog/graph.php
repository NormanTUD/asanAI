...
(() => {
  ...
  const NODES = [
    ...
    { id:'bpe',         label:'BPE Tokenization',                 short:'Gage 1994 (a compression algorithm) → Sennrich 2016 — short IDs replace longer strings',  era:'1990s',           row:8, col:10, stream:'language' },
