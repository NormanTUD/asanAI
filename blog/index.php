...
<div class="course-part">
	...
	<div class="course-tiles">
		<a href="intro.php" class="course-tile" style="--tile-accent: var(--mn-accent)">
		...
		<a href="intuition.php" class="course-tile" style="--tile-accent: var(--mn-accent)">
			<div class="course-tile-icon">&#128161;</div>
		...
		<a href="statistics.php" class="course-tile" style="--tile-accent: var(--mn-accent)">
			<div class="course-tile-icon">&#128200;</div>
			<h3>Statistics</h3>
...
<div class="course-part">
	...
	<div class="course-tiles">
		<a href="losslab.php" class="course-tile" style="--tile-accent: var(--mn-coral)">
			<div class="course-tile-icon">&#127919;</div>
...
<div class="course-part">
	...
	<div class="course-tiles">
		...
		<a href="normalizationlab.php" class="course-tile" style="--tile-accent: var(--mn-emerald)">
			<div class="course-tile-icon">&#9878;</div>
...
<div class="course-part">
	...
	<div class="course-tiles">
		...
		<a href="circuits.php" class="course-tile" style="--tile-accent: var(--mn-sky)">
			<div class="course-tile-icon">&#128268;</div>
			<h3>Circuits Inside LLMs</h3>
			<p>Mechanistic interpretability, induction heads, direct paths, and the residual stream.</p>
		</a>
		<a href="algorithms.php" class="course-tile" style="--tile-accent: var(--mn-sky)">
			<div class="course-tile-icon">&#128295;</div>
...
<div class="course-part">
	...
	<div class="course-tiles">
		...
		<a href="promptengineering.php" class="course-tile" style="--tile-accent: var(--mn-rose)">
			<div class="course-tile-icon">&#9999;</div>
...
<div class="course-part">
	...
	<div class="course-tiles">
		<a href="philosophy.php" class="course-tile" style="--tile-accent: var(--mn-text-secondary)">
			<div class="course-tile-icon">&#128218;</div>
			<h3>Philosophy &amp; Ethics</h3>
			<p>The Turing Test, the Vector Grounding Problem, Mary's Room, sentience, and what it means to think.</p>
		</a>
		<a href="appendix.php" class="course-tile" style="--tile-accent: var(--mn-text-secondary)">
			<div class="course-tile-icon">&#128214;</div>
			<h3>Appendix</h3>
