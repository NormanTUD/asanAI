...
Replace “token” with “patch” and “next word” with “next patch”. The math doesn't care. CLIP and ViT contain the same circuits as language Transformers: induction-style heads that complete visual patterns, superposition-packing of features, and sparse-autoencoder-decodable monosemantic units. The Distill essay on multimodal neurons in CLIP showed individual units firing — across vision and language alike — for single concepts like “spider web”, “skyscraper”, or a celebrity's face, exactly the kind of feature a SAE would isolate today \cite{goh2021multimodal}. See the <a href="computer_vision">Computer Vision chapter</a> for the hierarchical-feature view that mechanistic interpretability reverse-engineers.
</div>
