...
This has a profound implication for **cross-lingual translation**. When a Transformer is trained on two languages, each language develops its own embedding space. Remarkably, these spaces tend to be **isomorphic**, they share the same internal geometric structure, \cite[just rotated and scaled relative to each other]{mikolov2013exploiting}. The word for "king" in French and the word for "king" in English occupy analogous positions within their respective manifolds. \cite[Aligning two such spaces often requires nothing more than a linear transformation, a rotation matrix and a scaling factor, because the underlying topology of human concepts is, to a significant degree, language-invariant]{conneau2018word}.
