...
/* ══════════════════════════════════════════════════════════════════
   Isosurfaces of Probability: Truth Tunnels (ported from the former
   appendix). Standalone globals; mounted on blogPostLoadComplete.
   ══════════════════════════════════════════════════════════════════ */
// ============================================================
...
window.addEventListener('blogPostLoadComplete', function () {
    if (document.getElementById('canvas-isosurface')) { try { initIsosurface(); } catch (e) { console.error(e); } }
}, { once: true });
if (typeof window !== 'undefined' && window.__MN_DARK) {
    window.__MN_DARK.onChange(function () {
        if (document.getElementById('canvas-isosurface')) { try { initIsosurface(); } catch (e) { /* ignore */ } }
    });
}
