...
* **Barr's theorem.** Every Grothendieck topos admits a surjective geometric morphism from a topos satisfying the axiom of choice (equivalently, a Boolean topos) (Barr 1974). Since presheaf topoi satisfy AC, this means the easy theory of $[\mathcal{C}^{\mathrm{op}}, \mathbf{Set}]$ is dense — many results proved first for presheaf topoi transfer to all topoi.
