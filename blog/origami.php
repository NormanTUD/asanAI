...
* It is restricted to **fully-connected, deep feed-forward networks** on **classification**
  tasks. Extending it to convolutional and transformer architectures is flagged as future
  work (a natural first step: treat each conv filter patch as a tiny fully-connected net,
  where folding is only possible if there are *more* filters than data dimensions under the
  patch).
