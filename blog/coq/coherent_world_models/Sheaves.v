...
Definition sheaf_condition (F : Presheaf) (c : Context)
  ...
  forall (s1 s2 : Type),     (* sections in F(c_1) and F(c_2)               *)
    ...
    exists g : Type, True.     (* existence of a global section                *)
(* The placeholder hides the precise content: a concrete formalisation    *)
(* would parameterise by F(c_1), F(c_2), the overlap, the restrictions, and *)
(* the equality, and would require uniqueness (not just existence).         *)
