...
* **Earliest Signs:** Genomic evidence suggests that the unique human capacity for language was present at least **\cite[135,000 years ago]{earlylanguage}**, likely entering widespread social use by **100,000 years ago**. This “Cognitive Ignition” precedes the archaeological appearance of symbolic art like the \citetitle{blombosochre}.
...
Evidence of this symbolic transition is found in artifacts like the **\cite[Blombos Cave ochre]{blombosochre}** (c. 75,000 BCE), whose geometric engravings suggest abstract, non-utilitarian thought, and later mathematical tools like the **\cite[Lebombo Bone]{lebombobone}** (c. 41,000 BCE), likely used as a tally stick for tracking lunar cycles.
...
* **Tallies:** Objects like the Lebombo bone (ca. 41,000 BCE) represent even more specific data storage, likely used as mathematical tally sticks for tracking lunar cycles or inventories.
