...
Computers don't understand words. They understand numbers. So the very first thing an LLM does is **chop the input into small pieces called tokens**. We can first think of these tokens as words, but they need not to be. They can be sub-words, numbers or any part of a text. While we humans think in words, the LLM "thinks" in tokens.
