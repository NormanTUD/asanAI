...
const PEOrbitViz = (() => {
    ...
    const CONTEXT_WORDS = [
        { word: "Hund", pos: [1.35, 0.45], color: '#94a3b8' },
        { word: "schläft", pos: [0.05, -0.45], color: '#94a3b8' },
        { word: "die", pos: [-0.15, 0.75], color: '#94a3b8' },
        { word: "auf", pos: [-0.3, 0.1], color: '#94a3b8' },
        { word: "Sofa", pos: [1.1, -0.3], color: '#94a3b8' },
        { word: "kleine", pos: [0.25, 0.85], color: '#94a3b8' },
    ];
