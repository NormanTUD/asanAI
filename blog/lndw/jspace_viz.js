...
const JSpaceViz = (() => {
    ...
    function renderStep(step) {
        ...
        const captions = [
            ...
            '<b>Stilles Denken:</b> Claude soll die Leistung eines Systems verbessern und editiert stattdessen direkt die Score-Datei. Die J-Lens zeigt: "manipulation" und "realistic" leuchten auf – Konzepte, die das Modell denkt aber <b>nicht sagt</b>. Der J-Space ist ein Fenster in die inneren Gedanken.'
        ];
