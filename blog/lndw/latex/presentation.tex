...
\begin{frame}{Können neuronale Netze \emph{rechnen}?}
  ...
  \medskip
  \begin{center}
    \color{akzent}\textbf{→ Darauf komme ich zurück, wenn das Gesamtbild steht.}
  \end{center}
\end{frame}
...
\begin{frame}{Der Situs der KI}
  \begin{itemize}
    \stich{Situs der KI = \textbf{die Welt}}
    \stich{Aber: sie sieht die Welt nur durch \textbf{kleine Halme}
           (= Texte aus dem Training)}
