...
\begin{frame}{Holografische Kodierung}
  \begin{columns}[T]
    \column{0.48\textwidth}
    \begin{center}
      \includegraphics[width=0.9\linewidth]{hologram1.png}\\
      {\scriptsize\color{gray}Originalbild (z.\,B.\ Smiley)}
    \end{center}

    \column{0.48\textwidth}
    \begin{center}
      \includegraphics[width=0.9\linewidth]{hologram2.png}\\
...
\begin{frame}{Was passiert, wenn ein Teil fehlt?}
  \begin{columns}[T]
    \column{0.48\textwidth}
    \begin{center}
      \textbf{Normale Speicherung}\\[0.5em]
      \includegraphics[width=0.85\linewidth]{hologram1_1.png}\\[0.3em]
      {\scriptsize\color{gray}Ein Stück herausgeschnitten\\→ Information \textbf{unwiederbringlich weg}}
    \end{center}

    \column{0.48\textwidth}
    \begin{center}
      \textbf{Holografische Speicherung}\\[0.5em]
      \includegraphics[width=0.85\linewidth]{hologram2_2.png}\\[0.3em]
