...
\begin{frame}{Mannigfaltigkeiten – Übersetzung als Geometrie}
  \begin{columns}[T]
    \column{0.55\textwidth}
    \begin{itemize}
    ...
    \column{0.4\textwidth}
    \begin{center}
      % GIF-Einbindung: in Beamer als Animation nur mit speziellen Viewern,
      % alternativ als statisches Bild oder mit \animategraphics
      \animategraphics[autoplay,loop,width=\textwidth]{10}{frames/frames_}{001}{033}
      % Falls animategraphics nicht funktioniert, Fallback:
      % \includegraphics[width=\linewidth, keepaspectratio]{manifolds.gif}
      \\[0.3em]
