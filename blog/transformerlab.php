...
<div class="md">
    <h2>Transformer Explorer Pro: Deep Dive</h2>
    <p>Interaktive Analyse eines Forward-Passes. Unbekannte Wörter werden <span style="color:red; text-decoration:underline;">rot markiert</span>.</p>
</div>
...
<div class="transformer-grid" style="display: grid; gap: 20px;">
    ...
    <div class="panel">
        <h4>2. Self-Attention Matrix & Vektoren</h4>
        <div style="display: grid; grid-template-columns: auto 1fr; gap: 30px;">
            <div id="attn-matrix-container"></div>
            <div id="vector-details" style="display: flex; flex-direction: column; gap: 10px;">
                <div class="math-tex" id="math-attn-base"></div>
                <div id="vector-list" style="max-height: 250px; overflow-y: auto;"></div>
            </div>
        </div>
    </div>

    <div class="panel" style="background: #f0f9ff;">
        <h4>3. Residual Connection & FFN</h4>
...
<style>
    ...
    .attn-table th { font-size: 0.75rem; padding: 8px; color: #64748b; transform: rotate(-45deg); height: 50px; }
    .attn-table td { width: 45px; height: 45px; border: 1px solid #fff; text-align: center; font-size: 0.75rem; color: white; font-weight: bold; }
    .row-label { text-align: right !important; padding-right: 15px !important; font-weight: bold; color: #1e293b; white-space: nowrap; transform: none !important; }
