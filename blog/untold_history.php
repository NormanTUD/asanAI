...
<div class="md">
**The first art was a portrait of a woman.** The oldest undisputed images of a person are small figurines carved in the Aurignacian, some 40,000 to 35,000 years ago: the **Venus of Hohle Fels**, a six-centimetre carving of mammoth ivory from a cave near Schelklingen, is the oldest known depiction of a human being \cite[Conard, 2009]{conard2009hohlefels}, and the **Venus of Galgenberg**, nicknamed "Fanny", a serpentine statuette from the Stratzing excavation in Austria, is among the oldest accepted of its kind \cite[Neugebauer-Maresch, 1989]{neugebauer1989galgenberg}.

What these objects actually are is easier to see in hindsight than in the moment. They are the first time an idea inside a human head was **pulled out and made into a thing in the world**: a mental image of a person became a piece of ivory you could hold. That single move, externalising a model of the world out of the brain, is the same move, stretched across forty thousand years, that a neural network makes today, where the network's weights are a physical, external model of a concept exactly as the figurine was a physical model of a person. And the two ingredients behind every carving, a *creative* act that conjures a representation which did not exist, and the practical act of **working with the world** (stone, ivory, clay) to pin that idea into matter, are the deep ancestors of generation and of tool-use in machine learning.
