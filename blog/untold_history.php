...
<div class="md">
**The earliest undisputed figures are of women.** The oldest undisputed images of a person are small figurines carved in the Aurignacian, some 40,000 to 35,000 years ago: the **Venus of Hohle Fels**, a six-centimetre carving of mammoth ivory from a cave near Schelklingen, is the oldest known depiction of a human being \cite[Conard, 2009]{conard2009hohlefels}, and the **Venus of Galgenberg**, nicknamed "Fanny", a serpentine statuette from the Stratzing excavation in Austria, is among the oldest accepted of its kind \cite[Neugebauer-Maresch, 1989]{neugebauer1989galgenberg}. Abstract symbolic expression is older, but these are the earliest clear *figures* of a person.

What these objects already contain is a move that would run through the next forty thousand years: an idea inside a human head, **pulled out and made into a thing in the world**, a mental image of a person becoming a piece of ivory you could hold. That move, externalising a model of the world out of the brain, is the same move, stretched across forty thousand years, that a neural network makes today, where the network's weights are a physical, external model of a concept exactly as the figurine was a physical model of a person. And the two ingredients behind every carving, a *creative* act that conjures a representation which did not exist, and the practical act of **working with the world** (stone, ivory, clay) to pin that idea into matter, are the deep ancestors of generation and of tool-use in machine learning.
...
**From a body to a face.** The Venus figurines are schematic. The first *recognisable* faces came a little later: the carved-ivory **head from Dolní Věstonice** in the Czech Republic, about 26,000 years old, is one of the earliest known realistic depictions of a human face, and it is thought to model a specific elderly woman, whose buried skull shows the same one-sided distortion as the carving \cite{dolnivestonice}. A little later still, the engraved limestone slabs of **La Marche** in France, from the Magdalenian about 14,000 to 15,000 years ago, hold more than a hundred human figures, each with a distinct individual face, robes and even boots \cite{lamarchecave}, detailed portraiture that contemporaries doubted precisely because it looked so much like modern art.
