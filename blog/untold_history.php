...
External memory did not begin with writing. Long before paper or ink, humans outsourced counting to matter: the **Lebombo bone**, a baboon fibula with 29 notches from Border Cave (Eswatini/South Africa, c. 42,000–43,000 years ago), is the oldest known counting device, probably a lunar or menstrual calendar. The **Dolní Věstonice bone** — a wolf radius found by **\citeauthor{wolfbone}** in 1936 in Moravia, with 55 notches in two groups (30 and 25) on an 18 cm bone, dated to roughly 27,000 years ago — and the **Ishango bone** (c. 18,000 BCE, with columns of marks read as a base-12 counting aid) show that the same impulse to externalise quantity into physical marks arose independently in Africa and Europe. These notches are the first data ever written down: quantities pushed out of memory into the physical world, the direct ancestor of every counter, array, and database. Nothing older with a counting function is known; older notched bones (up to ~80,000 years old, e.g., Apollo 11, Namibia) exist, but their marks are likely decorative, and the oldest abstract pattern of all is a hatched flake from Blombos Cave (~71,000–73,000 years ago).
