...
The question received its most famous formulation from **Gottfried Wilhelm Leibniz**. Nothing exists without a reason; since the physical world is contingent, its explanation must lie outside itself in a **necessary being** whose non-existence would be logically impossible. This conviction that all reasoning is ultimately a form of calculation underlay his long-running *Characteristica Universalis* project (1679–1690); the 1686 treatise \cite[Generales Inquisitiones]{leibniz1686calculus} itself focuses on the logical analysis of notions and truths, not symbolic computation as such. The idea of reducing thought to calculation is articulated more explicitly in his earlier \cite[*Dissertio de Arte Combinatoria*]{leibniz1666combinatoria} (1666).
...
The picture of *how* the matter of the universe became the elements on the periodic table was assembled over more than a century, and its modern form rests on a single, remarkable convergence of nuclear physics and stellar astronomy. In the first few minutes after the Big Bang, the universe was a hot, dense plasma of protons and neutrons. As it expanded and cooled, protons and neutrons fused into the lightest nuclei before the density ever fell low enough for heavier ones to survive. The landmark 1948 calculation of \citeauthorlastnameand{alperbethegamow1948}, the famous "alpha-beta-gamma" paper, first showed that this process could predict the observed abundance of the light elements, and the full modern theory of **Big Bang nucleosynthesis** confirms that within roughly the first twenty minutes the universe had fused about **75% of its mass into hydrogen and 25% into helium-4**, leaving only traces of deuterium, helium-3, and lithium-7 \cite[as summarized in]{weinberg1977first}. This is a hard fact about the cosmos: nearly all the hydrogen in every atom on Earth, including the hydrogen in your body and in every drop of water, was made not inside any star but in those first twenty minutes.

Big Bang nucleosynthesis, however, could not make the rest. There is no stable nucleus with five or eight nucleons, a "mass gap" that stalls any chain of fusion beyond helium, so every element from carbon upward had to be forged later, inside stars. That insight was the work of a generation of physicists. In 1939, \citeauthor{bethe1939energy} worked out, in his paper \citetitle{bethe1939energy}, the **carbon-nitrogen-oxygen (CNO) cycle** by which more massive main-sequence stars convert hydrogen into helium. The closely related **proton-proton chain**, dominant in lower-mass stars like the Sun, had been proposed independently the year before by Carl Friedrich von Weizsäcker. Together these are the two nuclear reaction chains by which stars sustain their luminosity for millions to billions of years; a decade earlier, \citeauthorlastnameand{eddington1926stars} had already argued on purely physical grounds that nuclear fusion was the only way a star could stay hot so long, but it was Bethe (and Weizsäcker, for the pp-chain) who supplied the actual nuclear bookkeeping. As a star exhausts its hydrogen, its core contracts and heats until helium ignites. Fusing three helium nuclei into carbon through the unstable intermediate beryllium-8 could only work if carbon-12 possessed a particular excited state; Hoyle calculated this requirement in 1954, and the state was found shortly afterward almost exactly where he had placed it, the **Hoyle state**, a triumph that became one of the great confirmations of the whole theory \cite[as documented in the B2FH review]{b2fh1957}. From carbon, a cascade of successive "burning" stages in the most massive stars, carbon burning, neon burning, then onion-skin layers of oxygen and silicon burning, climbs the periodic table up to the iron group.

The iron group marks the absolute wall. Fusing nuclei up to iron *releases* energy; fusing iron *consumes* it, so an iron core cannot power a star. This is why the cosmic abundance of the elements has its deepest peak at iron, and it is the reason a massive star's life ends in a **core-collapse supernova**, a catastrophe whose rebounding shockwave drives a final burst of explosive nucleosynthesis and flings the star's freshly forged material out into space. But iron is not the end of the story: the heaviest elements, the gold, platinum, and uranium, are built by a different mechanism entirely, the **neutron-capture processes**. In the 1957 review that became the founding document of modern nucleosynthesis, \citetitle{b2fh1957}, \citeauthorlastnameand{b2fh1957} laid out both the **s-process** (slow neutron capture, proceeding in the gentle atmospheres of dying red-giant stars) and the **r-process** (rapid neutron capture, demanding the extreme neutron densities of stellar death), a framework first sketched the same year by \citeauthor{cameron1957nucleogenesis} \cite[as developed in]{b2fh1957}.

The r-process source was a mystery for six decades, until \citeyear{gw170817multimessenger}. On 17 August of that year, the LIGO and Virgo gravitational-wave detectors recorded the inspiral and merger of two neutron stars, the event GW170817, and within seconds a short gamma-ray burst was seen, and within days a glowing debris cloud, a **kilonova**, bloomed and faded in a distant galaxy \cite[as reported by the LIGO and Virgo collaborations]{gw170817multimessenger}. Spectral analysis of that glow showed it was powered by the radioactive decay of freshly synthesized heavy elements, and the \citeyear{kasen2017kilonova} analysis concluded that such mergers are a dominant cosmic factory for the r-process elements \cite[as demonstrated by]{kasen2017kilonova}. In one sentence: the gold in a ring, the platinum in a catalytic converter, and the uranium in the Earth's crust were all forged in the violent collisions of collapsing neutron stars, and we now hold the light of that very violence in hand.

Strip the logic together and a startling fact emerges: **you are made of star stuff**. The iron in your blood was forged in the core of a massive star and scattered by its supernova; the calcium in your bones and the oxygen in your lungs came from the same stellar furnaces; the gold in your body was made when two neutron stars collided; and only the hydrogen was truly primordial, a relic of the first minutes. The silicon, the copper, the gold, and the rare earths of which a modern computer is built all entered the periodic table through these same stellar and supernova forges. No atom in a semiconductor, no metal in a wire bond, no element in the periodic table that a chipmaker uses, was ever made by the Big Bang alone. Every one of them was manufactured inside, or exploded out of, a star.

### The Birth and Death of Stars

Stars are not so much born as *fallen*. They form when a cold, dense region of a **giant molecular cloud**, a vast structure of molecular hydrogen and dust at temperatures near ten kelvin, grows massive enough for its own gravity to overwhelm the pressure of its gas. The criterion for this was worked out by \citeauthor{jeans1902nebula} in 1902: a cloud fragment collapses if it exceeds the **Jeans mass**, a threshold that drops as the gas gets denser and colder, so a cold, dense core is one that is doomed to collapse and make stars \cite[as derived in]{jeans1902nebula}. As a core collapses, conservation of angular momentum flings much of its material into a spinning **protoplanetary disk** around a central **protostar**, and the protostar heats under gravity until, after a few hundred thousand years, its core reaches a temperature at which hydrogen fusion ignites and hydrostatic equilibrium is achieved. The star has arrived on the **main sequence**.

The energy source that lets a main-sequence star shine for millions to billions of years is the nuclear fusion that \citeauthorlastnameand{eddington1926stars} first proposed and \citeauthorlastnameand{bethe1939energy} quantified. A star like the Sun fuses about **six hundred billion kilograms of hydrogen every second**, converting a small fraction of that mass into pure energy. When the core hydrogen is gone, the star's fate is set by its mass. A low- to intermediate-mass star swells into a **red giant**, flashes on helium, and finally sheds its outer layers as a **planetary nebula**, leaving behind a **white dwarf**: an Earth-sized ember of carbon and oxygen so dense that a single teaspoon of it would weigh several tonnes. How massive such a remnant can become before electron degeneracy pressure fails is fixed by a limit that \citeauthor{chandrasekhar1935structure} derived in the early 1930s and developed in his 1935 monograph \citetitle{chandrasekhar1935structure}, the **Chandrasekhar limit** of about 1.4 solar masses, a number that also determines when a white dwarf in a binary system can be pushed over the edge and detonate as a Type Ia supernova, one of astronomy's most useful standard candles \cite[as established in]{chandrasekhar1935structure}.

A star massive enough, roughly eight solar masses or more, never settles for a white dwarf. Its core collapses all the way to a **neutron star**, an object about the size of a city yet a full solar mass in weight, so dense that a single cubic centimetre of it weighs billions of tonnes. When such a neutron star spins and sweeps a beam of radiation across us, its emission arrives as a steady, clocklike pulse, and it was precisely this that \citeauthorlastnameand{hewish1968pulsar} reported in 1968 when they detected the first **pulsar**, an object so strange it was jokingly nicknamed "little green men" before the explanation arrived \cite[as first reported by]{hewish1968pulsar}. The most massive cores of all collapse past even this, their gravity so extreme that not even light escapes, into **black holes**: regions bounded by an event horizon whose radius for a stellar mass is only a few kilometres.

None of this was done for us. But the very first stars, the **Population III** generation, which ignited within a few hundred million years of the Big Bang out of pristine hydrogen and helium, did the one thing that made everything possible: they burned, died, and scattered the first heavy elements into the gas, ending the cosmic "dark ages" and reionizing the universe. Only after several generations of stars had lived and died was the interstellar medium rich enough in carbon, oxygen, silicon, iron, and the rest for a planetary system like ours to form at all.

### The Making of Planets

The idea that the Sun and the planets condensed from a single rotating disk of gas and dust is older than modern astronomy. \citeauthor{kant1755heavens}, in his 1755 \citealternativetitle{kant1755heavens}, first proposed that the Solar System had formed by the gravitational settling of a nebula, an idea later given mathematical form by Laplace; it was not until the early 1980s, when disks of gas were directly imaged around young stars, that the **nebular hypothesis** was confirmed as the standard model of planet formation \cite[as first proposed by]{kant1755heavens}. Our own system began when a fragment of a giant molecular cloud collapsed roughly **4.57 billion years ago** to make a protostar, the Sun, ringed by a hot, dense **protoplanetary disk** of gas and dust. The age of the Solar System is measured by radiometric dating of the oldest solids ever found, the calcium-aluminium-rich inclusions in meteorites, which predate any planet and fix the clock at about 4.57 billion years \cite[as measured by]{amelin2010solarsystem}.

Within that disk, planets grew by accretion. Microscopic dust grains bumped and stuck into pebbles, pebbles into kilometre-sized **planetesimals**, and planetesimals, by gravity, into **planetary embryos**. The disk's temperature gradient decided everything: inside the **frost line**, a few astronomical units from the young Sun, only metals and silicates could condense, so the inner planets, Mercury, Venus, Earth, and Mars, became small and rocky; beyond it, volatiles such as water ice could freeze out, adding so much solid material that a core could grow to about ten Earth masses and then grab a giant envelope of gas, the mechanism by which **Jupiter and Saturn** assembled in the core-accretion picture \cite[as dated by the oldest meteorite solids]{amelin2010solarsystem}. The terrestrial planets accreted over the first few tens of millions of years; the Earth, our own, is dated to roughly 4.5 billion years \cite[as reviewed by Allègre et al.]{allegre1995age}. The final architecture, the present spacing and tilts of the giant planets, is thought to have been set by a late dynamical instability that scattered planetesimals inward and stirred the outer disk, the **Nice model** \cite[as proposed by]{gomes2005nice}.

The Earth and the Moon share a violent origin. Tens of millions of years into the Solar System's formation, a Mars-sized protoplanet, conventionally named **Theia**, struck the proto-Earth, and the Moon accreted from the disk of vaporized debris that the impact flung into orbit \cite[as proposed by Hartmann and Davis]{hartmann1975satellite}. A high-energy "giant-impact" version of this scenario, in which the impactor struck near the very end of Earth's accretion, is the best supported today and accounts for the striking isotopic similarity between the Moon and the Earth \cite[as modeled by]{canupasphaug2001moon}.
...
**The First Cells: 3.8–3.5 Billion Years Ago.** The earliest secure evidence for life on Earth is geological, not morphological. In 1986, \citeauthorlastnameand{walter1986stromatolites} reported microbially induced sedimentary structures older than 3,470 million years from the Dresser Formation in the Pilbara craton, Western Australia \cite[as described in]{walter1986stromatolites}: layered, millimetre-scale laminations produced only by the mat-like growth of microbial communities, the fossil descendants of modern stromatolites. Two years earlier, a bolder claim had appeared: \citeauthorlastnameand{cloud1973isotope} argued in \citeyear{cloud1973isotope} that carbon-isotope fractionation in 3,800-million-year-old graphite from the Isua supracrustal belt in Greenland recorded the metabolic signature of living organisms \cite[as reported in]{cloud1973isotope}. That particular claim has since been contested, but the broader conclusion, that life was present on Earth by at least 3.5 Ga, is now secure. In \citeyear{vankranendonk2016microbial}, \citeauthorlastnameand{vankranendonk2016microbial} described 3,700-million-year-old filamentous microfossils and spheroidal cells from the Dresser Formation, pushing the secure morphological record back a further 200 million years \cite[as documented in]{vankranendonk2016microbial}.
...
**The Great Oxidation Event: ~2.4 Billion Years Ago.** For the first two billion years of life's history, Earth's atmosphere and oceans were reducing, rich in hydrogen, methane, and dissolved iron, and essentially oxygen-free. The transition to an oxygenated atmosphere, the **Great Oxidation Event (GOE)**, was driven by the photosynthetic activity of cyanobacteria, whose oxygen, initially consumed by dissolving oceanic iron, eventually began to accumulate. The primary evidence is the disappearance of **mass-independent sulfur isotope fractionation** (S-MIF), a photochemical process that ceases once atmospheric oxygen exceeds a few hundred parts per million. \citeauthorlastnameand{frei2009chromium} showed in \citeyear{frei2009chromium} that chromium isotope ratios in banded iron formations record pre-GOE oxygen pulses as early as 3.5 Ga, indicating that cyanobacterial oxygen production began far earlier than the GOE itself, but was consumed by the vast reducing capacity of the oceans \cite[as demonstrated in]{frei2009chromium}. \citeauthorlastnameand{canfield2011ferruginous} argued that the dominant ocean state from 3.5 to 1.8 Ga was not anoxic but **ferruginous**, anoxic but iron-rich, a condition that explains both the banded iron formations and the long delay between the onset of oxygenic photosynthesis and the GOE \cite[as explained in]{canfield2011ferruginous}. The GOE was, in effect, a biological extinction event: it poisoned most of the existing anaerobic biosphere, but it also unlocked the energy yields of aerobic respiration, roughly eighteen times more efficient than anaerobic metabolism, setting the stage for the complexity that followed.

**The First Eukaryotes: ~2.0–1.0 Billion Years Ago.** The transition from prokaryotic to eukaryotic cells, the acquisition of a membrane-bound nucleus, mitochondria, and the endomembrane system, is the single most important cellular transition in the history of life, because it is the prerequisite for multicellularity, and multicellularity is the prerequisite for the brain. The oldest unambiguous eukaryotic fossil is *Bangiomorpha pubescens*, a 1.05-billion-year-old red alga described by \citeauthorlastnameand{butterfield2000bangiomorpha} in \citeyear{butterfield2000bangiomorpha} \cite[as described in]{butterfield2000bangiomorpha}: a simple multicellular organism with a thickened cell wall, which is also the earliest evidence for eukaryotic sex. Biomarker evidence (24-methylcholestane, a sterol found only in eukaryotes) pushes the origin of eukaryotes back to at least 2.2 Ga.

**The First Multicellular Organisms: ~2.1–1.56 Billion Years Ago.** In \citeyear{elalbani2010gabon}, \citeauthorlastnameand{elalbani2010gabon} described large colonial filaments, up to five centimetres in diameter, from the 2.1-billion-year-old Francevillian Group in Gabon \cite[as reported in]{elalbani2010gabon}. The structures show evidence of coordinated growth and division of labor among cells, and their existence implies that local oxygen levels, even if the global atmosphere was still anoxic, were sufficient to support multicellular metabolism. In \citeyear{zhu2016multicellular}, \citeauthorlastnameand{zhu2016multicellular} reported decimetre-scale multicellular eukaryotic fossils from the 1.56-billion-year-old Gaoyuzhuang Formation in North China \cite[as documented in]{zhu2016multicellular}, demonstrating that large, complex eukaryotic multicellularity preceded the GOE by over a billion years.

**The Ediacaran Fauna: 571–538 Million Years Ago.** After a long interval in which the fossil record is dominated by microbial mats and simple algae, a remarkable array of large, soft-bodied, morphologically novel organisms appeared in the late Ediacaran period. \citeauthorlastnameand{sprigg1947ediacara} in \citeyear{sprigg1947ediacara} first described the Ediacara fauna from the Ediacara Hills of South Australia: jellyfish-like, frond-like, and quilted organisms with no clear affinity to any living phylum \cite[as originally described in]{sprigg1947ediacara}.
...
Among the most enigmatic of these is *Dickinsonia*, a flat, bilaterally symmetric, ribbed organism up to 40 centimetres long, found on four continents. For decades its biological affinity was unknown: a fungus, a mat, a protist, or an animal? In \citeyear{bobrovskiy2018dickinsonia}, \citeauthorlastnameand{bobrovskiy2018dickinsonia} analysed cholesteroid lipids, specifically the sterol **cholestanol**, preserved in 558-million-year-old *Dickinsonia* fossils from the White Sea in Russia. Cholestanol is synthesized only by animals; its presence in the fossil tissue, in the correct concentration range and absent from the surrounding rock, established *Dickinsonia* as a metazoan \cite[as demonstrated in]{bobrovskiy2018dickinsonia}. This made *Dickinsonia* one of the earliest known animals, predating the Cambrian Explosion by more than 130 million years.
...
\citeauthorlastnameand{brocks2017rise} provided the broader context in \citeyear{brocks2017rise}: biomarker evidence (dinosterane, a steroid made only by dinoflagellate and related algae; and cholesterane, an animal sterol) from Cryogenian sediments indicates that the rise of eukaryotic algae and the emergence of animals were coupled, with animals appearing in the late Cryogenian, roughly 635–541 Ma \cite[as established in]{brocks2017rise}.

**The Cambrian Explosion: ~538 Million Years Ago.** The Ediacaran fauna was abruptly replaced, within a few million years, by the first appearance of nearly all modern animal phyla: arthropods, molluscs, chordates, echinoderms, annelids, and the rest. This rapid diversification, the **Cambrian Explosion**, is the single most dramatic event in the history of animal life.

The original description of the best-preserved Cambrian fauna came from \citeauthorlastnameand{walcott1911burgess} in \citeyear{walcott1911burgess}, who excavated the **Burgess Shale** in the Canadian Rockies and described over 70 species, including the strange *Anomalocaris*, *Opabinia*, and the chordate *Pikaia* \cite[as first described in]{walcott1911burgess}. Walcott interpreted most of the fauna as phyllopod crustaceans, a reading that persisted for decades. In \citeyear{whittington1979burgess}, \citeauthorlastnameand{whittington1979burgess} re-examined the fossils with modern techniques and revealed a fauna of extraordinary morphological disparity, including animals with no living relatives, and established the Burgess Shale as the type locality for the Cambrian Explosion \cite[as re-analysed in]{whittington1979burgess}.
...
The Chinese **Chengjiang lagerstätte**, described in the early 2000s, extended the story: \citeauthorlastnameand{shu2001chengjiang} reported primitive deuterostomes, including the tailed chordate *Vetulicola*, from the 518-million-year-old Chengjiang biota in Yunnan \cite[as described in]{shu2001chengjiang}; \citeauthorlastnameand{hou2003chengjiang} provided the comprehensive description of the fauna as the oldest known preserved animal community \cite[as documented in]{hou2003chengjiang}.
...
**From Cambrian to Human: The Long Ascent.** Over the following 500 million years, life colonized land (plants at ~470 Ma, tetrapods at ~375 Ma), developed flight (insects at ~400 Ma, dinosaurs at ~220 Ma, birds at ~150 Ma), and produced the lineage that led to primates (~65 Ma), to the human-chimpanzee split (~6–7 Ma), and to *Homo sapiens* (~300 Ka). The trajectory from a single prokaryotic cell in a hydrothermal vent to the human brain that conceived the Transformer is not a straight line but a contingent branching process, yet every node in that tree is a *necessary condition* for the next: no GOE, no eukaryotes; no eukaryotes, no multicellularity; no multicellularity, no nervous system; no nervous system, no brain; no brain, no mathematics; no mathematics, no silicon; no silicon, no LLM.
...
### The Mythos: How Story Shaped the Mind

Before science, there was story. Every pre-scientific civilisation explained the natural world through **mythos**: narratives in which gods, spirits, and cosmic beings directly caused natural phenomena. The sun was a chariot driven across the sky; the seasons were the result of a god's moods; earthquakes were the anger of a deity beneath the earth. This was not "wrong" in the modern sense; it was a *different kind of model*, one in which agency was located in personal beings rather than in impersonal laws.

Yet mythos was not merely an obstacle to science. It created specific mental prerequisites without which the scientific revolution would have been unthinkable:

* **The intelligibility of nature.** The Greek mythological tradition, inherited from the Hittites and Mesopotamians, contained a radical idea: the cosmos was not the arbitrary whim of a capricious god but the expression of a rational order, *kosmos* (κόσμος), as opposed to *chaos* (χάος). The opening of Hesiod's *Theogony* (c. 700 BCE) tells of the emergence of order from formless void. This is the mythological seed of the scientific conviction that nature is *legible*, that there are regularities to be discovered.

* **The homunculus model and the Great Chain of Being.** The medieval synthesis of Aristotelian biology and Christian theology produced the **Great Chain of Being** (*scala naturae*): a fixed, ranked hierarchy of all creation, from inert minerals at the bottom, through plants, animals, humans, angels, to God at the top. \citeauthorlastnameand{thomas1274summa} integrated this hierarchy into Christian doctrine in his \citetitle{thomas1274summa} (c. 1265–1274) \cite[as systematized in]{thomas1274summa}. The chain was *static*: each species held an immutable rank. This model dominated Western thought for over a millennium. Its legacy for computation is paradoxical: the chain's legacy is the idea of **discrete, nested, ranked categories**, the intuition of a *level of abstraction* and a *class*. When \citeauthorlastnameand{linnaeus1758systema} published the 10th edition of \citetitle{linnaeus1758systema} in \citeyear{linnaeus1758systema}, he was still working within the chain's logic: nature as a fixed, ranked taxonomy \cite[as presented in]{linnaeus1758systema}. It was not until \citeauthorlastnameand{darwin1859origin}'s \citetitle{darwin1859origin} (\citeyear{darwin1859origin}) that the ladder was replaced by a **branching tree** \cite[as argued in]{darwin1859origin}. The tree structure that survives in phylogeny is exactly the shape of hierarchical information organization: file systems, type hierarchies, ontologies.
...
### The Birth of Natural Philosophy: From Thales to Archimedes

The transition from mythos to **logos** (λόγος), from story to reasoned argument, began in the Greek city-states of Ionia in the 6th century BCE. The Milesian natural philosophers, **Thales of Miletus** (c. 624–546 BCE), **Anaximander** (c. 610–546 BCE), and **Anaximenes** (c. 586–526 BCE), made a move that had no precedent in any prior tradition: they proposed that natural phenomena could be explained without reference to the will of gods. Thales argued that water was the fundamental substance (*arche*) of all things; Anaximander proposed the boundless (*apeiron*); Anaximenes proposed air. These explanations were, by modern standards, wrong. But the *form* of the explanation, a natural cause operating according to a natural principle, was a revolution.

**Democritus of Abdera** (c. 460–370 BCE) went further still: he proposed that all matter is composed of indivisible particles, **atoms** (ἄτομα, "uncuttable"), moving in the void. The theory was atomism, and it was not merely a philosophical curiosity: it was a *computational* model of the physical world. Atoms are discrete units; the void is the substrate in which they move; the rules of their interaction are mechanical, not divine. The parallel to the modern digital computer is exact: discrete units (bits) on a substrate (silicon), manipulated by deterministic rules (logic gates).

**Aristotle of Stagira** (384–322 BCE) systematized natural knowledge on an unprecedented scale. His \citetitle{aristotle1685history} (c. 350 BCE) described and ranked approximately 500 animal species, ordering them by "perfection": degree of sensory equipment, presence or absence of blood, complexity \cite[as recorded in]{aristotle1685history}. His \citetitle{aristotle1685meteorologica} (Meteorologica) established the sublunary/celestial cosmology: the lower world of the four elements (earth, water, air, fire) is changeable and corruptible; the upper world of the aether is eternal and unchanging. This cosmology blocked the scientific revolution for two millennia, because it *forbade* the idea that the same laws govern the heavens and the Earth. But Aristotle also created the other tool: **syllogistic logic**, the first formal system of deductive reasoning. A syllogism, "All men are mortal; Socrates is a man; therefore Socrates is mortal," is a *computation*: a fixed rule applied to premises to produce a necessary conclusion. Without the syllogism, there is no formal logic; without formal logic, there is no Boolean algebra; without Boolean algebra, there is no digital circuit.

**Archimedes of Syracuse** (c. 287–212 BCE) made the first systematic application of mathematics to physical problems. His \citetitle{archimedes250method} (c. 250 BCE, reconstructed from the 10th-century Archimedes Palimpsest) used a form of **integral calculus** to compute the area under a curve and the centre of mass of a parabolic segment \cite[as reconstructed in]{archimedes250method}. The method was "mechanical": he balanced geometric figures as if they had weight, using the lever as a computational device. This is the first known instance of using a *physical model* (the lever) to solve a *mathematical problem* (quadrature), an inversion that would be repeated in every analog computer from the Antikythera mechanism to the differential analyser.

### The Islamic Golden Age: The Bridge

Between the fall of the Western Roman Empire and the European Renaissance, the centre of gravity of scientific thought shifted to the Islamic world. The scholars of the **Abbasid Caliphate** (750–1258 CE) did not merely preserve Greek texts; they extended them, corrected them, and applied them in ways the Greeks had not imagined.

**Muhammad ibn Musa al-Khwarizmi** (c. 780–850 CE) wrote the \citetitle{alkhwarizmi820algebra} (c. 820 CE), the first systematic treatise on algebra, a work that gave the discipline its name (al-jabr, "the reunion of broken parts") and the discipline of *algorithm* its name (a Latinization of al-Khwarizmi's name) \cite[as established in]{alkhwarizmi820algebra}. The book solved linear and quadratic equations by geometric and arithmetic methods, and its procedures, step-by-step, unambiguous, mechanical, are the direct ancestors of the *algorithms* that now run on every GPU.

**Ibn al-Haytham (Alhazen)** (965–1040 CE) wrote the \citetitle{ibnalhaytham1021optics} (\citeyear{ibnalhaytham1021optics}), a seven-volume work that established the **experimental method** as the foundation of optics and, by extension, of natural philosophy \cite[as described in]{ibnalhaytham1021optics}. Against the Greek emission and intromission theories of vision, Ibn al-Haytham argued, on the basis of controlled experiments, that vision occurs when light from an object enters the eye, and he designed the first controlled experiments in the history of science: varying one parameter at a time, recording the result, and drawing a general conclusion. The \citetitle{ibnalhaytham1021optics} also described the **camera obscura**, the direct optical ancestor of the photographic camera, the microscope, and the camera that will one day image a brain. The experimental method he codified, hypothesis, controlled experiment, quantitative measurement, general law, is the method that the Royal Society would formalize three centuries later and that the entire empirical science underlying AI depends on.
...
**Copernicus: The First Displacement.** \citeauthorlastnameand{copernicus1543revolutionibus}'s \citetitle{copernicus1543revolutionibus}, published in Nuremberg by Johannes Petreius in \citeyear{copernicus1543revolutionibus} (the year of his death), moved the Earth from the centre of the cosmos to a planet orbiting the Sun \cite[as proposed in]{copernicus1543revolutionibus}. The intellectual shock was not primarily astronomical but *metaphysical*: if the Earth is not the centre, then the human being is not the centre, and the Great Chain of Being, which had placed humanity at the navel of creation, is broken. The book was placed on the Index of Prohibited Books in 1616 and remained there until 1758. But the idea, once released, could not be contained.
...
**Galileo: The Method and the Telescope.** \citeauthorlastnameand{galileosidereus}'s \citetitle{galileosidereus} (\citeyear{galileosidereus}), published in Venice in March 1610, reported the first telescopic observations of the night sky: the moons of Jupiter, the phases of Venus, the mountains of the Moon, the innumerable stars invisible to the naked eye \cite[as reported in]{galileosidereus}. The moons of Jupiter were the decisive observation: if Jupiter has its own satellites, then not everything orbits the Earth, and the Ptolemaic system is false. But \citetitle{galileosidereus} was only the beginning. In \citetitle{galileodialogo} (\citeyear{galileodialogo}), the \citetitle{galileodialogo}, published in Florence in Italian (not Latin) to reach a wider audience, Galileo argued for the Copernican system and against the Aristotelian physics of natural places and uniform circular motion \cite[as argued in]{galileodialogo}. The book was condemned by the Roman Inquisition in 1633; Galileo was forced to abjure and spent his remaining years under house arrest. But the method he embodied, the subordination of authority to observation, of received doctrine to experiment, was the deeper revolution, and it could not be suppressed.

**Bacon: The Method of Science.** \citeauthorlastnameand{bacon1620novumorganum}'s \citetitle{bacon1620novumorganum} (\citeyear{bacon1620novumorganum}) proposed an inductive method for the advancement of learning: begin with careful, systematic observation of particulars; ascend by gradual generalization to axioms and then to general laws; test the resulting theories by further observation \cite[as proposed in]{bacon1620novumorganum}. Bacon's method was not, in practice, the method that the scientists of the 17th century used (they were largely hypothetico-deductive, like Galileo and Newton), but it established the *ideal* of science as a progressive, cumulative, evidence-driven enterprise, an ideal that the Royal Society, founded in 1660, was created to institutionalize.

**Descartes: The Machine and the Doubt.** \citeauthorlastnameand{descartes1637discours}'s \citetitle{descartes1637discours} (\citeyear{descartes1637discours}) began with a method of systematic doubt: doubt everything that can be doubted, and see what remains. What remains is the thinking self, the *cogito*: "I think, therefore I am." The second part of the work, \citetitle{descartesgeometrie}, introduced the **analytic geometry** that unites algebra and geometry: a curve is an equation; a point is a pair of numbers. This is the conceptual foundation of every coordinate system in which a neural network's weight space is now visualized \cite[as introduced in]{descartesgeometrie}.

But it was the suppressed \citetitle{descartes1664lemonde} (\citeyear{descartes1664lemonde}), published posthumously, that contained the deeper displacement \cite[as published in]{descartes1664lemonde}. Descartes proposed that the physical world, including the human body, is a **machine** (*horologium*): a self-operating mechanism governed by the same mechanical laws as a clock. Animals are automata; the body, after death, is a machine that has stopped. The *soul* (or mind, *res cogitans*) is non-physical and cannot be a machine. But the *body* is. This is the seed of the "brain as computer" idea: if the body is clockwork, then the question "can the thinking part also be a mechanism?" becomes coherent. Descartes kept the soul off the machine, but he put the organism on it. The step from "the body is a machine" to "the brain is a computer" was taken, in mathematics, by \citeauthorlastnameand{mccullochpitts1943} in \citeyear{mccullochpitts1943} \cite[as demonstrated in]{mccullochpitts1943}; in engineering, by the designers of the first neural networks.

**Newton: The Unification.** \citeauthorlastnameand{newtonprincipia}'s \citetitle{newtonprincipia} (\citeyear{newtonprincipia}), published for the Royal Society in London with the imprimatur of Samuel Pepys and financed and edited by Edmond Halley, is the single most important work in the history of physical science \cite[as presented in]{newtonprincipia}. The *Principia* unified terrestrial and celestial mechanics under a single law: the **law of universal gravitation**, $F = G \frac{m_1 m_2}{r^2}$, and the three **laws of motion**. Kepler's empirical laws became *consequences* of a deeper principle. The Moon falls toward the Earth with the same acceleration that an apple falls with; the planets orbit the Sun for the same reason that a stone whirled on a string does not fly off. The universe is a **deterministic machine**: given the positions and velocities of all particles at one instant, the entire future and past is fixed by the laws of motion. This is **Laplace's demon** in embryo: the intellect that, knowing all forces and positions, could compute the entire future and past of the universe from a single formula. The demon passage appears in Laplace's \citetitle{laplace1814essai} (\citeyear{laplace1814essai}) \cite[as stated in]{laplace1814essai}.

The *Principia* also contained the first rigorous formulation of **calculus** (independent of Leibniz's), the mathematical machinery for describing change. Without calculus, there is no differential equation; without differential equations, there is no differential geometry, no action principle, no variational method, and no of the optimization algorithms that train a neural network.

**Leibniz: The Calculus of Reasoning.** \citeauthorlastnameand{leibniz1686calculus} was working on a project that Newton never conceived: a **universal characteristic** (*Characteristica Universalis*), a formal language in which all concepts are expressed as symbols and all reasoning is performed as calculation. The idea is that all reasoning is, at bottom, a form of computation. The \citetitle{leibniz1666combinatoria} (\citeyear{leibniz1666combinatoria}) articulated the ambition: "If disputes should arise between scholars, it would be unnecessary for them to argue with one another... They can say, let us calculate" \cite[as proposed in]{leibniz1666combinatoria}. The \citetitle{leibniz1686calculus} (\citeyear{leibniz1686calculus}) developed the logical analysis of notions and truths that would, three centuries later, become the foundation of formal logic and, ultimately, of the logic gate \cite[as developed in]{leibniz1686calculus}.
...
**Probability: The Calculus of Uncertainty.** In 1654, the Chevalier de Méré, a professional gambler, posed a question to \citeauthorlastnameand{pascalfirmat1654}: how should the stakes in an interrupted game of dice be fairly divided? The correspondence that followed, between Pascal and Fermat, is the founding document of **probability theory** \cite[as established in]{pascalfirmat1654}. \citeauthorlastnameand{huygens1657ratiociniis}'s \citetitle{huygens1657ratiociniis} (\citeyear{huygens1657ratiociniis}), the first book on probability, introduced **expected value** as the central concept \cite[as defined in]{huygens1657ratiociniis}.

\citeauthorlastnameand{bayes1763essay} died in 1761, leaving behind a manuscript, "An Essay towards Solving a Problem in the Doctrine of Chances," which his friend Richard Price discovered and published in the *Philosophical Transactions of the Royal Society* in \citeyear{bayes1763essay} \cite[as published in]{bayes1763essay}. The essay solves a problem of **inverse probability**: given the data, what is the probability of the hypothesis that generated it? This is **Bayesian inference**, and it is the mathematical engine of every probabilistic machine learning model, from the Perceptron's update rule to the variational autoencoder.

\citeauthorlastnameand{laplace1812analytic}'s \citetitle{laplace1812analytic} (\citeyear{laplace1812analytic}) independently derived and generalized Bayes's result, unified probability with the theory of errors, and applied it to astronomical prediction \cite[as established in]{laplace1812analytic}. His \citetitle{laplace1814essai} (\citeyear{laplace1814essai}) added the **Laplace demon** and the **central limit theorem**, the result that the sum of a large number of independent random variables tends toward a Gaussian distribution \cite[as proven in]{laplace1814essai}. The central limit theorem is the reason that **backpropagation** works: the gradient of a loss function over millions of parameters is a sum of many small, roughly independent contributions, and its distribution is approximately Gaussian, which is why the stochastic gradient estimator is so effective.

**Logic as Algebra: The Bridge to Circuits.** In 1847, \citeauthorlastnameand{boole1847analysis} published \citetitle{boole1847analysis}, the first attempt to reduce logic to algebra \cite[as proposed in]{boole1847analysis}. In \citetitle{boole1854laws} (\citeyear{boole1854laws}), he gave the definitive statement: logic *is* an algebra of 0/1 quantities, in which the operations of AND, OR, and NOT correspond to multiplication, addition, and complementation \cite[as established in]{boole1854laws}. This is **Boolean algebra**, and it is the algebra of the logic gate.

The bridge from Boolean algebra to physical circuits was built by \citeauthorlastnameand{shannon1938relay} in his MIT master's thesis, "A Symbolic Analysis of Relay and Switching Circuits," published in the *Transactions of the AIEE* in \citeyear{shannon1938relay} \cite[as demonstrated in]{shannon1938relay}. Shannon showed that Boole's algebra is **isomorphic** to the algebra of two-state electrical circuits: AND is switches in series; OR is switches in parallel; NOT is an inverter. A logical formula can be *wired into a physical circuit*, and the circuit can *compute* the truth value of the formula. This is the moment at which logic became hardware. Without Shannon's 1938 thesis, the digital computer is a philosophical curiosity; with it, it is an engineering discipline.

**Information: The Quantification of Signal.** In \citeyear{shannon1948communication}, \citeauthorlastnameand{shannon1948communication} published "A Mathematical Theory of Communication" in the *Bell System Technical Journal*, formalizing everything the telegraph and cryptography had intuited but never measured \cite[as established in]{shannon1948communication}. **Information** is a quantifiable, measurable, transmissible quantity. The unit is the **bit**. **Entropy** measures the average information in a message. **Channel capacity** is the maximum rate at which information can be transmitted reliably over a noisy channel. The **channel coding theorem** guarantees that reliable communication is possible up to a fundamental limit. Shannon's 1948 paper is the theoretical foundation of every error-correcting code, every compression algorithm, and every communication protocol that carries the weights of a language model across the internet.

### The Convergence

The transition from mythos to computation is not one invention but the **convergence of five independent intellectual revolutions**:

| Revolution | Key Figures | Concept Contributed | Where It Lives in an LLM |
|---|---|---|---|
| **Classification** (Aristotle → Linnaeus → Darwin) | Aristotle, Linnaeus, Darwin | Discrete, nested, ranked categories; then the **tree** | Type systems; hierarchical organization of information |
| **Mechanism** (Descartes → Newton → Laplace) | Descartes, Newton, Laplace | The world (incl. the brain) as a **deterministic, rule-governed mechanism** | The computer as a mechanism; the "brain as computer" idea |
| **Probability** (Pascal/Fermat → Bayes → Laplace) | Pascal, Fermat, Bayes, Laplace | A calculus of **uncertainty** | Statistical learning; inference under noise; all of probabilistic ML |
| **Logic as Algebra** (Boole → Shannon) | Boole, De Morgan, Peirce, Shannon | Logic as **symbolic algebra** → realizable in **switches** | The logic gate; the digital circuit; computation as wired logic |
| **Information** (Telegraph → Shannon 1948) | Morse, Shannon | **Information** as a quantifiable, transmissible quantity | The bit; coding; error correction; the "content" of data |

Each of these revolutions was driven by problems that had nothing to do with computation: how to classify the animals of the known world, how to justify the divine order, how to divide the stakes in an interrupted game, how to wire a telegraph switch, how to measure the capacity of a communication channel. Yet together, they produced the *mental landscape* in which the idea of a machine that reasons became not only possible but inevitable. The LLM is the endpoint of a convergence that began when a Greek philosopher in Miletus looked at the sea and decided that it did not need a god to explain it.
</div>
...
<figure>
    <img style="width: 60%; height: auto; display: block; margin: 1em auto;" src="huygens_aerial_telescope_1684.jpg" alt="Engraving of the tubeless aerial telescope of Christiaan Huygens, 1684, an early lens-based instrument that extended human perception" />
    <figcaption class="md">The \citealternativetitle{img_huygens_aerial_telescope} (Public Domain): the tubeless aerial telescope of \citeauthor{img_huygens_aerial_telescope}, drawn in \citeyear{img_huygens_aerial_telescope} — a lens-based instrument of the same lineage as Galileo's refractor, extending human perception to the heavens. Source: \citeauthor{img_huygens_aerial_telescope}, \citeyear{img_huygens_aerial_telescope}, \citealternativetitle{img_huygens_aerial_telescope}, Wikimedia Commons.</figcaption>
</figure>
</div>
...
<figure>
    <img style="width: 100%; height: auto; display: block;" src="micrographia_cork.jpg" alt="Hooke's drawing of the pores (cells) of a thin slice of cork, from Micrographia, 1665" />
    <figcaption class="md">\citealternativetitle{img_micrographia_cork} (Public Domain): the honeycombed pores of a thin slice of cork, no thicker than the 400th part of an inch, as drawn for \citetitle{micrographia}. It was looking at this dead plant tissue that \citeauthor{micrographia} coined the word “cell”. Source: \citeauthor{img_micrographia_cork}, \citeyear{img_micrographia_cork}, \citealternativetitle{img_micrographia_cork}, Wikimedia Commons.</figcaption>
</figure>

<div class="image-row">
    <figure>
        <img src="micrographia_title_page.gif" alt="Title page of Micrographia, 1665" />
        <figcaption class="md">The \citealternativetitle{img_micrographia_titlepage} (Public Domain): the title page of the 1665 folio, the Royal Society's first major publication and the first scientific best-seller.</figcaption>
    </figure>
    <figure>
        <img src="hooke_cock_microscope.jpg" alt="Compound microscope manufactured by Christopher Cock of London for Robert Hooke" />
        <figcaption class="md">The \citealternativetitle{img_hooke_cock_microscope} (Public Domain): the compound microscope manufactured by Christopher Cock of London for \citeauthor{micrographia}, believed to be the instrument with which he made the observations in \citetitle{micrographia}. Source: \citeauthor{img_hooke_cock_microscope}, \citeyear{img_hooke_cock_microscope}, \citealternativetitle{img_hooke_cock_microscope}, Wikimedia Commons.</figcaption>
    </figure>
</div>

**The tenants of the honeycomb.** While Hooke saw the architecture, a draper in Delft named **\citeauthor{leeuwenhoekletters}** saw who lived in it. Grinding his own single-lens microscopes to magnifications well beyond 200×, he reported from the 1670s onward, in letters to the Royal Society, on the “animalcules” swimming in pond water, on red blood cells, on spermatozoa — the first observations of living cells and of microorganisms \cite{leeuwenhoekletters}. Between the two men the microscope completed its first revolution: from an instrument of *description* to an instrument of *discovery*.

**From observation to doctrine.** It took another 170 years for the cell to become a principle. In \citeyear{schleiden1838} \citeauthor{schleiden1838} argued that all plant tissues are built of cells; in \citeyear{schwann1839} \citeauthor{schwann1839} extended the claim to animals, proposing that the tissues of *all* organisms are composed of cells — the birth of **cell theory** \cite{celltheory_wiki}. \citeauthor{virchow1858} later closed the triad with *omnis cellula e cellula*, every cell from a cell, in his \citeyear{virchow1858} cellular pathology \cite[as established in]{virchow1858}. For the first time, a single unit, visible only through a lens, was declared sufficient to explain the structure of every living thing.

**The stubborn exception: the brain.** Cell theory met one recalcitrant tissue. Under the microscopes of the early nineteenth century — limited by chromatic and spherical aberration, by natural light, and by crude dyes and fixatives — brain tissue appeared as a continuous mesh, a net without individual parts, the **reticular theory**. It was the technical limits of microscopy, not any fact about the brain, that kept the neuron hidden \cite{neuron_doctrine_wiki}.

The break came from a histological trick. In \citeyear{golgi1873}, **Camillo Golgi** invented a silver-impregnation method he called *la reazione nera*, the black reaction: it stained a small, random subset of nerve cells entirely black against a pale yellow background, so that for the first time an individual neuron, with its highly branched dendrites and axon, could be seen clearly \cite{golgi1873}. The irony is that Golgi himself read the stain as evidence of continuity, and defended the reticular theory for the rest of his career.

**The neuron doctrine.** It was **\citeauthor{cajal1888}** who read the stain the other way. Starting in 1887, he applied Golgi's method with unmatched skill, and in the May 1888 issue of the *Revista Trimestral de Histología Normal y Patológica* reported that the nerve cells of the bird's brain are **discrete**, not continuous \cite{cajal1888} \cite{neuron_doctrine_wiki}. That report is the founding document of the **neuron doctrine**: the nervous system is not a net but a vast society of individual cells, each a complete cell in its own right, connected to its neighbours by points of contact rather than by cytoplasmic continuity. \citeauthor{waldeyer1891} named the unit *neuron* in \citeyear{waldeyer1891}; Cajal then spent two decades mapping it through every region of the human and animal brain, publishing his drawings in works such as \citetitle{cajaltextura} (\citeyear{cajaltextura}). Golgi and Cajal shared the 1906 Nobel Prize in Physiology or Medicine, their dispute surviving the award and being settled only in the 1950s, when electron microscopy revealed the physical gap at the **synapse** \cite{neuron_doctrine_wiki}.

<figure>
    <img style="width: 100%; height: auto; display: block;" src="cajal_cerebellum.jpg" alt="Santiago Ramón y Cajal's drawing of the cells of the chick cerebellum, 1905" />
    <figcaption class="md">The \citealternativetitle{img_cajal_cerebellum} (Public Domain): the cells of the chick cerebellum as \citeauthor{cajaltextura} drew them. The reticular theory, a single continuous mesh, had been the consensus of his generation; each black-inked cell in this drawing is a separate individual, the unit of the neuron doctrine and the direct ancestor of the “neuron” in a neural network. Source: \citeauthor{img_cajal_cerebellum}, \citeyear{img_cajal_cerebellum}, \citealternativetitle{img_cajal_cerebellum}, Wikimedia Commons.</figcaption>
</figure>

**Why the neuron doctrine is a prerequisite of AI.** The neuron doctrine is a displaced prerequisite in the strongest sense: it is what made the brain a *computable object*. Before Cajal, the brain was a mesh, something like telegraph wiring, with nothing discrete to model. After Cajal, it was a network of individual, excitable units that send all-or-none signals to each other across discrete contacts. That picture — a discrete unit with a threshold, wired into a network — is exactly the picture that \citeauthorlastnameand{mccullochpitts1943} turned in \citeyear{mccullochpitts1943} into a mathematical model, a network of threshold neurons capable of computing any computable function \cite{mccullochpitts1943}. \citeauthor{hebb1949organizationofbehaviour}'s \citeyear{hebb1949organizationofbehaviour} rule that “cells that fire together wire together” \cite{hebb1949organizationofbehaviour}, and \citeauthor{rosenblatt1958perceptron}'s \citeyear{rosenblatt1958perceptron} Perceptron \cite{rosenblatt1958perceptron}, both stand on that histological fact. The word “neuron” in “neural network” is a direct descendant of the unit Cajal drew in 1888. No microscope, no neuron doctrine. No neuron doctrine, no connectionism. No connectionism, no neural networks.

**Why the microscope is still in the causal chain.** The instrument has not retired from the chain either. Its descendant, the **electron microscope**, is indispensable to semiconductor fabrication: at today's feature sizes, below the wavelength of visible light, defects in a chip cannot be found or measured by optical microscopy, and electron microscopes are what inspect, measure, and failure-analyse the silicon on which every inference runs. The same idea of the lens, which in 1665 revealed a honeycomb in a slice of cork, now watches over the making of the dies that train language models.

**The deepest displacement: the method.** The most profound debt is neither model nor instrument but *method*. As \citeauthorlastnameand{olaha2020zoomin} put it in their \citeyear{olaha2020zoomin} essay \citetitle{olaha2020zoomin}, “many important transition points in the history of science have been moments when science ‘zoomed in’”: microscopes let us see cells, leading to cellular biology; x-ray crystallography let us see DNA, leading to the molecular revolution. And now, they argue, deep learning may stand at a similar transition point:

<div class="smart-quote" data-cite="olaha2020zoomin">
Just as the early microscope hinted at a new world of cells and microorganisms, visualizations of artificial neural networks have revealed tantalizing hints and glimpses of a rich inner world within our models.
</div>

Their “circuits” programme treats individual neurons and even individual weights as objects of serious investigation, spending “thousands of hours tracing through every neuron and its connections”. What emerges are **circuits**: meaningful algorithms inside the weights — a circle detector assembled from curves, a dog's head assembled from eyes, snout, fur, and tongue, even circuits implementing AND, OR, and XOR over high-level visual features \cite{olaha2020zoomin}.

And the parallel is deliberately architectural. \citeauthorlastnameand{olaha2020zoomin} model their framework on \citeauthor{schwann1839}'s \citeyear{schwann1839} three claims about the cell — that the cell is the unit of structure, physiology, and organization in living things; that it retains a dual existence as a distinct entity and as a building block in the construction of organisms; that cells form into the organism — and propose three corresponding claims about neural networks: (1) *features* are the fundamental unit of a network, and can be rigorously studied and understood; (2) features are connected by weights into *circuits*, computational subgraphs that can likewise be rigorously studied; (3) analogous features and circuits form *universally* across models and tasks \cite{olaha2020zoomin}. Just as cell theory made the cell the unit on which biology was rebuilt, the circuits programme is trying to make the feature the unit on which the science of AI will be rebuilt.
...
<div class="image-row">
    <figure>
        <img src="iron_pillar_delhi.jpg" alt="The Iron Pillar of Delhi, an 1,600-year-old wrought-iron column that has resisted corrosion, standing in the Qutb complex" />
        <figcaption class="md">The \citealternativetitle{img_iron_pillar_delhi} (Public Domain): the \citealternativetitle{ironpillardelhi}, a wrought-iron column that has resisted corrosion for over 1,600 years through a self-forming passive film, a metallurgical result no one set out to engineer \cite[as analysed in]{ironpillardelhi}. Source: \citeauthor{img_iron_pillar_delhi}, \citeyear{img_iron_pillar_delhi}, \citealternativetitle{img_iron_pillar_delhi}, Wikimedia Commons.</figcaption>
    </figure>
    <figure>
        <img src="bessemer_converter.jpg" alt="A Bessemer converter, the vessel that dropped the price of steel by a factor of ten in the 1850s" />
        <figcaption class="md">The \citealternativetitle{img_bessemer_converter} (Public Domain): the \citealternativetitle{bessemerpatent}, the process that turned steel from a precious craft metal into an industrial commodity \cite[as patented in]{bessemerpatent}. Source: \citeauthor{img_bessemer_converter}, \citeyear{img_bessemer_converter}, \citealternativetitle{img_bessemer_converter}, Wikimedia Commons.</figcaption>
    </figure>
</div>
...
<figure>
    <img style="width: 40%; height: auto; display: block; margin: 1em auto;" src="cai_lun.jpg" alt="Portrait of Cai Lun, the Han-dynasty official who in 105 CE described a scalable process for making paper from bark, hemp and rags" />
    <figcaption class="md">The \citealternativetitle{img_cai_lun} (Public Domain): \citeauthor{cai_lun_paper}, the Han-dynasty official whose \citeyear{cai_lun_paper} court memorial described a scalable process for making paper from mulberry bark, hemp, rags and fishnets, the breakthrough that turned a precious writing surface into an industrial substrate \cite[as recorded in]{cai_lun_paper}. Source: \citeauthor{img_cai_lun}, \citeyear{img_cai_lun}, \citealternativetitle{img_cai_lun}, Wikimedia Commons.</figcaption>
</figure>
</div>
...
<figure>
    <img style="width: 45%; height: auto; display: block; margin: 1em auto;" src="huygens_horologium_1673.jpeg" alt="Title page or plate from Christiaan Huygens' Horologium Oscillatorium (1673), the foundational treatise on the pendulum clock" />
    <figcaption class="md">The \citealternativetitle{img_huygens_horologium} (Public Domain): \citeauthor{huygenspendulum}'s \citetitle{huygenspendulum} (\citeyear{img_huygens_horologium}), the treatise that gave the pendulum clock its geometric and mathematical foundations, the instrument whose escapement broke continuous time into countable, synchronous steps \cite[as established in]{huygenspendulum}. Source: \citeauthor{img_huygens_horologium}, \citeyear{img_huygens_horologium}, \citealternativetitle{img_huygens_horologium}, Wikimedia Commons.</figcaption>
</figure>
</div>
...
<figure>
    <img style="width: 100%; height: auto; display: block;" src="watt_steam_engine_lauder.jpg" alt="James Eckford Lauder's painting of James Watt and the steam engine, showing the engineer at his separate-condenser engine" />
    <figcaption class="md">The \citealternativetitle{img_watt_steam_engine} (Public Domain): \citeauthor{wattpatent} and his separate-condenser engine, the device that made steam power economical enough to drive the machine tools of precision manufacturing \cite[as patented in]{wattpatent}. Source: \citeauthor{img_watt_steam_engine}, \citeyear{img_watt_steam_engine}, \citealternativetitle{img_watt_steam_engine}, Wikimedia Commons.</figcaption>
</figure>
</div>
...
<figure>
    <img style="width: 100%; height: auto; display: block;" src="gutta_percha_cable.png" alt="Engraving of the apparatus used to wrap the copper wires of the transatlantic cable in gutta-percha insulation, after Louis Figuier" />
    <figcaption class="md">The \citealternativetitle{img_gutta_percha_cable} (Public Domain): the apparatus for wrapping the copper conductors of the \citealternativetitle{atlantictelegraph} in \citealternativetitle{guttapercha}, the silent other half of the telegraph, the insulator whose stubbornness let the signal *stay* a signal across a mile-deep ocean \cite[as documented in]{atlantictelegraph}. Source: \citeauthor{img_gutta_percha_cable}, \citeyear{img_gutta_percha_cable}, \citealternativetitle{img_gutta_percha_cable}, Wikimedia Commons.</figcaption>
</figure>
