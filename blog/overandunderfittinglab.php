...
| **Overfitting** (High Variance) | 7 – 10 | Very low | High | The curve contorts wildly to pass through every noisy dot. Training MSE drops but test MSE climbs, the classic signature of overfitting. |
