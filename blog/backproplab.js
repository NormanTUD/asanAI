...
$$${cv(C.out,'o_2')} = \\text{sigmoid}\\left(\\underbrace{${cv(C.out,f(R.zo2))}}_{z_{o_2}}\\right) = ${cv(C.out,f(R.o2))}$$
$$\\frac{\\partial E}{\\partial o_2} = -(\\underbrace{${cv(C.tgt,f(t2))}}_{t_2} - \\underbrace{${cv(C.out,f(R.o2))}}_{o_2}) = ${f(R.dE_do2)}$$
...
<div class="bp-section bp-section-hid"><b>① Forward Pass — How $${cv(C.hid,hLabel)}$ was computed</b>
...
$$${cv(C.hid,hLabel)} = \\text{sigmoid}\\!\\left(${cv(C.hid,f(zh))}\\right) = ${cv(C.hid,f(hVal))}$$
</div>
...
<div class="bp-section bp-section-out"><b>② Forward Pass — How $${cv(C.out,oLabel)}$ was computed</b>
...
$$${cv(C.out,oLabel)} = \\text{sigmoid}\\!\\left(${cv(C.out,f(zo))}\\right) = ${cv(C.out,f(oVal))}$$
</div>
