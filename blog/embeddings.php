...
<div class="grid-layout" style="display: grid; grid-template-columns: 1fr 1.5fr; gap: 20px; margin-top: 20px;">
    <div class="layers-vertical" style="display: flex; flex-direction: column; gap: 15px;">
        ...
        <div style="display: flex; gap: 5px;">
            <input type="text" id="vec-input" class="bw-cell" style="flex-grow: 1; padding: 15px; border: 2px solid #3b82f6; border-radius: 8px; font-size: 1.1rem;" placeholder="e.g. King - Man + Woman">
            <button class="btn" style="background:#3b82f6; color:white; padding: 0 20px; border-radius: 8px; cursor:pointer; font-weight: bold;" onclick="calcVector()">Calculate</button>
        </div>
        
        <div id="vec-console" class="status-console" style="height: 100px; overflow-y: auto; background: #f8fafc; padding: 10px; border: 1px solid #e2e8f0; border-radius: 8px; font-family: monospace; font-size: 0.85rem;">
            <strong>History:</strong>
        </div>

        <div class="vocab-box" style="background: #fff; padding: 12px; border: 1px solid #e2e8f0; border-radius: 8px;">
            <span style="font-size: 0.75rem; font-weight: bold; color: #64748b; display: block; margin-bottom: 5px;">AVAILABLE:</span>
