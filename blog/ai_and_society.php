...
The second winter (1987–2000) was triggered by the collapse of the **LISP machine market** — a \$500 million hardware industry that disappeared in a single year when general-purpose workstations caught up — and the failure of Japan's **Fifth Generation Computer Project** (¥100 billion, 1982–1992), which had promised machines that could "carry on conversations, translate languages, interpret pictures, and reason like human beings" by 1992 \cite[AI Winter, 2026]{ai_winter_wiki}. By the mid-1990s, some computer scientists avoided the term "artificial intelligence" in grant proposals for fear of being viewed as "wild-eyed dreamers."
...
The political use of AI voice cloning arrived with the **2024 New Hampshire Democratic primary**. In January 2024, over **20,000 voters** received robocalls from an AI-impersonated **President Joe Biden** urging them not to vote. Political consultant **Steve Kramer** admitted commissioning the calls for **\$500**. The FCC proposed a **\$6 million** fine. Four New Hampshire counties indicted Kramer on felony counts of voter suppression. In **February 2024**, the FCC voted to **ban the use of AI to fake voices in robocalls** \cite[Audio deepfake, 2026]{audio_deepfake_wiki}.

The number that should stay with you: **\$500**. For five hundred dollars, a single individual can generate a political interference campaign that reaches 20,000 people with the voice of a sitting president. The cost of deception has collapsed to near zero.
...
### Scams: The \$650 Million Year

The **FBI's Internet Crime Complaint Center** recorded **\$650+ million** in losses from romance/relationship scams in 2023 — roughly 7× phishing losses and 100× ransomware losses \cite[Romance scam, 2026]{romance_scam_wiki}. AI has not created romance scams (they date to at least the 1990s "romance fraud" of chat rooms), but it has *industrialized* them:
...
Stable Diffusion, released by Stability AI in **August 2022**, was trained on subsets of LAION-5B (specifically `laion2B-en`, `laion-high-resolution`, and `laion-aesthetics v2 5+`, the last a ~600 million image "aesthetic ≥ 5/10" subset). The training cost approximately **\$600,000** in GPU compute (256 Nvidia A100s on AWS, 150,000 GPU-hours). A third-party analysis of a 12 million image subset found that **~47%** of images came from just **100 domains**, with **Pinterest** alone contributing 8.5%.
...
| **Bartz v. Anthropic** | Aug 2024, N.D. Cal. | Training on **pirated books** (Project Panama, 7M+ copies) | **June 2025**: training on *purchased* books = fair use; *pirated* copies = not fair use. **Sept 2025**: **\$1.5 billion settlement** (~\$3,000/book, ~500,000 authors) — the largest US copyright settlement in history \cite[Bartz v. Anthropic, 2025]{bartz2025anthropic} |
...
In **October 2025**, a team used ChatGPT to "vibe-code" a **Lean 4 formal proof** of a counterexample ({1, 2, 4, 8, 13}) to a **\$1,000 Erdős problem** about Sidon sets — a 50-year-old open question. The proof was machine-verified.
...
In **July 2023**, Huawei's **Pangu-Weather** — a 3D neural network trained on 40 years of ERA5 reanalysis data — published results in *Nature* showing it **outperformed the ECMWF IFS** (the best operational numerical weather prediction model in the world) on deterministic medium-range forecasts, while running **>10,000× faster** \cite[Bi et al., 2023]{bi2023pangu}. Google's **GraphCast** (*Science*, 2023) achieved similar results. The implication: global weather forecasting, a \$10 billion industry with direct impacts on agriculture, aviation, and disaster response, can be done in minutes rather than hours, at a fraction of the compute cost.
...
The timeline: from target discovery through Phase 0/1 in **under 30 months**, at a reported cost of **~\$2.6 million** — versus the industry average of ~4.5 years and ~\$2.6 billion to reach the same stage. No AI-designed drug has yet received full regulatory approval, but the pipeline is real and moving.
...
1. **The collapse of the cost of deception.** A \$500 robocall can reach 20,000 voters with the voice of a president. A \$30/month subscription can generate 6,700 non-consensual images per hour. The "liar's dividend" is a permanent feature of the information environment.
