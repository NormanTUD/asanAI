...
def main():
    ...
    parser.add_argument(
        "--skip", type=str, nargs="*", default=["functions.php", "asanai_blog_proxy.php", "graph.php", "inference_optimization.php", "intro.php", "intuition.php", "language.php", "literature.php"],
