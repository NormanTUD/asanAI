...
The neural revolution in language modeling began with \citeauthorlastnameand{neuralprobabilistic}'s \citeyear{neuralprobabilistic} paper \citetitle{neuralprobabilistic}, which replaced sparse n-gram tables with dense, continuous **word embeddings**, learned vector representations capturing semantic similarity. This was supercharged in 2013 by **Word2Vec** (\citeauthorlastnameand{mikolov2013word2vec}, Google), which efficiently trained embeddings on large corpora and revealed striking algebraic properties of language (e.g., *king − man + woman ≈ queen*). In 2018, **ELMo** (Peters et al., Allen Institute for AI) introduced **contextualized embeddings** that changed depending on surrounding context, finally addressing polysemy.
