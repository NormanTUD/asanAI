...
The popular attribution to LeCun obscures a longer Japanese prior art, which \citeauthor{schmidhuber2025cnn} documents in detail. **Kunihiko Fukushima** introduced **rectified linear units (ReLUs)** in \citeyear{schmidhuber2025cnn} — the same activation function that powers essentially every modern Transformer — and the basic **Neocognitron** architecture with alternating convolutional and downsampling layers in \citeyear{neocognitron}, inspired by Hubel and Wiesel's cat visual-cortex work. **Alex Waibel**, a German researcher in Japan, trained supervised one-dimensional convolutional NNs with weight-sharing (TDNNs) on Linnainmaa's 1970 backpropagation in \citeyear{schmidhuber2025cnn} for speech recognition, and introduced the term *convolution* into NNs. **Wei Zhang** at Osaka then built the first *modern* two-dimensional CNN trained by backpropagation in \citeyear{schmidhuber2025cnn}, applied to character recognition — one year *before* LeCun's 1989 Bell Labs paper. LeCun's later 1998 survey, widely read as the canonical CNN reference, does not cite Zhang. Schmidhuber reads this as a recurring Anglosphere pattern: real innovations made in Ukraine, Japan, Finland or Switzerland get re-popularized from Toronto or New York with the original authors omitted. Whether or not one accepts his polemical framing, the technical timeline is well-attested in the original papers.
</div>
