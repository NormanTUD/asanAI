...
Researchers have long debated whether the artifact served as a simple tally, a **lunar calendar** as suggested by \citeauthor{marshackishango}, or a more complex mathematical tool. De Heinzelin’s original 1957 publication, \citetitle{ishangobone}, introduced the bone to the scientific community, sparking decades of inquiry into the "mathematical Out of Africa" theory. Modern scholars like **Vladimir Pletser** continue to investigate its potential use as a primitive "slide rule" or evidence of a base-12 counting system, marking it as a critical precursor to later mechanical calculation aids. It could also have been a counting system, where quantities of something have been represented by notches in the bone. It is not clear exactly what it was used for, though.
