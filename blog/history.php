...
The consequences were staggering. Within a decade, millions of people were voluntarily uploading text: personal websites, forums, blogs, news articles, encyclopedias, academic papers, product reviews, fan fiction, legal opinions, recipes, poetry, code repositories, and every other form of human expression. By the 2010s, organizations like **\citetitle{commoncrawl}** were archiving billions of web pages, creating open datasets of hundreds of terabytes of raw text.

### The Web as Training Corpus

This is the direct, causal link to modern AI. A large language model learns by ingesting text, as much text as possible, in as many domains, registers, and languages as possible. The datasets that power models like GPT-3 and its successors (such as \citetitle{commoncrawl}, WebText, and Wikipedia dumps) are direct products of the Web's open, self-publishing architecture. Without Berners-Lee's decision to make the Web royalty-free and without the open protocols of TCP/IP, the digital text generated by humanity would have remained fragmented across proprietary, incompatible, and inaccessible systems, bulletin boards, corporate intranets, and gated databases. There would be no single, crawlable, interlinked ocean of human language.
