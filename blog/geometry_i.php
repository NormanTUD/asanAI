...
This chapter follows that growth step by step. For each turn we ask four questions: **what** was discovered, **who** did it, **when**, and — the question that makes a history interesting — **why**, what need of the age forced the result to exist. We start where the physical evidence actually begins: not with a Greek theorist, but with a hand tool pressing a zig-zag into a river shell. We then cross the first cities, where geometry became a *job* (surveying land after the flood), pass through the Greek invention of *proof*, the medieval and early-modern reformulation of space in terms of projection and coordinates, and finally the 19th-century discovery that space need not be *flat* — the idea that later made general relativity possible, and that underlies the high-dimensional "spaces of meaning" you will meet in the [Embeddings](embeddinglab) chapter.
</div>

<div class="md">
## I. Before writing: space etched in shell and bone

The oldest geometric objects we have are not calculations at all, and their purpose was not practical or religious, but simply to make space *orderly*. The very oldest is not even a mark but a *shape* — a handaxe, a three-dimensional object worked to a mental template of symmetry and proportion a million and a half years before anyone etched a line. After it come the *patterns*: marks made by a hand that was doing something else (shaping a tool, decorating, keeping score), in which a deliberate regularity shows up. That regularity is the first thing geometry notices — the sense that *the same shape* can be repeated, and that repeating it is meaningful. No one sat down to invent geometry; geometry is what a shape-making, pattern-making mind leaves behind when it is not, strictly, being *about* geometry at all.
...
The books are organised by theme: **Book I** is plane geometry (angles, triangles, the Pythagorean theorem as **I.47**, and the *converse* as I.48); **Book VI** develops proportion and **similar triangles**, which is how the Greeks did "algebra with lengths"; **Book XII** applies the method of exhaustion to area and volume (the area of the circle, and that a cone is a third of its cylinder); and **Book XIII** closes the whole edifice by constructing the five **regular solids** — the tetrahedron, cube, octahedron, dodecahedron and icosahedron — tying geometry back to the Platonic idea that the cosmos is built from five shapes.
...
When the Greek world passed its knowledge eastward, it was not lost but *worked on* — the motive was as much legal as scholarly: Islamic inheritance law required estates to be divided into fractional shares, and the *kharaj* land tax required surveying, so the new science of **algebra** served the counting of the estate as directly as it served the counting of the stars. In the great translation and research centres of the Islamic world — above all the **House of Wisdom** in Baghdad (8th–13th c.) — the *Elements*, the *Conics* and the astronomical treatises were rendered into Arabic, corrected, and extended. Figures such as **al-Khwārizmī** (c. 780–850) re-founded algebra (the very word is his, from *al-jabr*, "the restoring/completing") and did so in the *geometric* spirit inherited from Babylon and Greece, solving equations by the same cutting-and-completing-of-the-square operations \cite{hoyrup2021algebra}.
