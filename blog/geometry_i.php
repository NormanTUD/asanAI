...
The oldest geometric objects we have are not calculations at all, and their motive was not profit or piety but a quieter need: to make space *orderly*. The very oldest is not even a mark but a *shape* — a handaxe, a three-dimensional object worked to a mental template of symmetry and proportion a million and a half years before anyone etched a line. After it come the *patterns*: marks made by a hand that was doing something else (shaping a tool, decorating, keeping score), in which a deliberate regularity shows up. That regularity is the first thing geometry notices — the sense that *the same shape* can be repeated, and that repeating it is meaningful. No one sat down to invent geometry; geometry is what a shape-making, pattern-making mind leaves behind when it is not, strictly, being *about* geometry at all.
