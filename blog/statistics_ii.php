...
In modern AI:
* **Latent Dirichlet Allocation (LDA)** \cite[Blei et al., 2003]{blei2003lda} — the foundational topic model.
...
The EM algorithm \cite[Dempster et al., 1977]{dempster1977em} finds maximum-likelihood estimates when the model has latent variables:
