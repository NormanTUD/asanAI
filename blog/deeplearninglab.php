...
As we saw in the discussion on the **Minimal Neuron**, a single unit performs a linear transformation followed by an activation. However, the true power of Modern AI, what we call **Deep Learning** (first named as such by \citeauthor{deeplearningfirstuse} in \citeyear{deeplearningfirstuse}, though in a slightly different context), emerges when we stack these neurons into multiple successive layers.
