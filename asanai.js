...
class asanAI {
	...
	is_valid_web_color (color) {
		const webColors = [
			"abbey", "absolute zero", "acadia", "acapulco", "acid green",
			"aero", "aero blue", "affair", "african violet", "air force blue",
			"air superiority blue", "akaroa", "alabama crimson", "alabaster", "albescent white",
			"algae green", "alice blue", "alien armpit", "alizarin crimson", "alloy orange",
			"allports", "almond", "almond frost", "alpine", "alto",
			"aluminium", "amaranth", "amaranth pink", "amaranth purple", "amaranth red",
			"amazon", "amber", "american rose", "americano", "amethyst",
			"amethyst smoke", "amour", "amulet", "anakiwa", "android green",
			"anti flash white", "antique brass", "antique bronze", "antique fuchsia", "antique ruby",
			"antique white", "anzac", "ao", "apache", "apple",
			"apple blossom", "apple green", "apricot", "apricot white", "aqua deep",
			"aqua forest", "aqua haze", "aqua island", "aqua spring", "aqua squeeze",
			"aquamarine", "aquamarine blue", "arapawa", "arctic lime", "armadillo",
			"army green", "arrowtown", "arsenic", "artichoke", "arylide yellow",
			"ash", "ash grey", "asparagus", "asphalt", "astra",
			"astral", "astronaut", "astronaut blue", "athens gray", "aths special",
			"atlantis", "atoll", "au chico", "aubergine", "auburn",
			"aureolin", "auro metal saurus", "australian mint", "avocado", "axolotl",
			"azalea", "aztec", "aztec gold", "azure", "azure mist",
			"azureish white", "baby blue", "baby blue eyes", "baby powder", "bahama blue",
			"bahia", "baja white", "baker miller pink", "bali hai", "ball blue",
			"baltic sea", "bamboo", "banana mania", "banana yellow", "bandicoot",
			"barberry", "barbie pink", "barley corn", "barley white", "barn red",
			"barossa", "bastille", "battleship gray", "bay leaf", "bay of many",
			"bazaar", "bdazzled blue", "beau blue", "beauty bush", "beaver",
			"beeswax", "beige", "belgion", "bermuda", "bermuda gray",
			"beryl green", "bianca", "big dip oruby", "big foot feet", "big stone",
			"bilbao", "biloba flower", "birch", "bird flower", "biscay",
			"bismark", "bison hide", "bisque", "bistre", "bitter",
			"bitter lemon", "bittersweet", "bittersweet shimmer", "bizarre", "black",
			"black bean", "black coral", "black forest", "black haze", "black leather jacket",
			"black marlin", "black olive", "black pearl", "black rock", "black rose",
			"black russian", "black shadows", "black squeeze", "black white", "blackberry",
			"blackcurrant", "blanched almond", "blast off bronze", "blaze orange", "bleach white",
			"bleached cedar", "bleu de france", "blizzard blue", "blond", "blossom",
			"blue", "blue bayoux", "blue bell", "blue chalk", "blue charcoal",
			"blue chill", "blue diamond", "blue dianne", "blue gem", "blue gray",
			"blue green", "blue haze", "blue jeans", "blue lagoon", "blue magenta violet",
			"blue marguerite", "blue ribbon", "blue romance", "blue sapphire", "blue smoke",
			"blue stone", "blue violet", "blue whale", "blue yonder", "blue zodiac",
			"blueberry", "bluebonnet", "blumine", "blush", "bole",
			"bombay", "bon jour", "bondi blue", "bone", "booger buster",
			"bordeaux", "bossanova", "boston blue", "boston university red", "botticelli",
			"bottle green", "boulder", "bouquet", "bourbon", "boysenberry",
			"bracken", "brandeis blue", "brandy", "brandy punch", "brandy rose",
			"brass", "breaker bay", "brick red", "bridal heath", "bridesmaid",
			"bright cerulean", "bright gray", "bright green", "bright lavender", "bright lilac",
			"bright maroon", "bright navy blue", "bright red", "bright sun", "bright turquoise",
			"bright ube", "bright yellow", "brilliant azure", "brilliant lavender", "brilliant rose",
			"brink pink", "british racing green", "bronco", "bronze", "bronze olive",
			"bronze yellow", "bronzetone", "broom", "brown", "brown bramble",
			"brown derby", "brown pod", "brown rust", "brown sugar", "brown tumbleweed",
			"brown yellow", "brunswick green", "bubble gum", "bubbles", "buccaneer",
			"bud", "bud green", "buddha gold", "buff", "bulgarian rose",
			"bull shot", "bunker", "bunting", "burgundy", "burlywood",
			"burnham", "burning orange", "burning sand", "burnished brown", "burnt maroon",
			"burnt orange", "burnt sienna", "burnt umber", "bush", "buttercup",
			"buttered rum", "butterfly bush", "buttermilk", "buttery white", "byzantine",
			"byzantium", "cg blue", "cg red", "cab sav", "cabaret",
			"cabbage pont", "cactus", "cadet", "cadet blue", "cadet grey",
			"cadillac", "cadmium green", "cadmium orange", "cadmium red", "cadmium yellow",
			"cafe noir", "cafe royale", "cal poly green", "calico", "california",
			"calypso", "camarone", "cambridge blue", "camelot", "cameo",
			"cameo pink", "camouflage", "camouflage green", "can can", "canary",
			"canary yellow", "candlelight", "candy apple red", "cannon black", "cannon pink",
			"cape cod", "cape honey", "cape palliser", "caper", "capri",
			"caput mortuum", "caramel", "cararra", "cardin green", "cardinal",
			"cardinal pink", "careys pink", "caribbean green", "carissma", "carla",
			"carmine", "carmine pink", "carmine red", "carnaby tan", "carnation",
			"carnation pink", "carnelian", "carolina blue", "carousel pink", "carrot orange",
			"casablanca", "casal", "cascade", "cashmere", "casper",
			"castleton green", "castro", "catalina blue", "catawba", "catskill white",
			"cavern pink", "cedar", "cedar chest", "cedar wood finish", "ceil",
			"celadon", "celadon green", "celery", "celeste", "celestial blue",
			"cello", "celtic", "cement", "ceramic", "cerise",
			"cerise pink", "cerulean", "cerulean blue", "cerulean frost", "chablis",
			"chalet green", "chalky", "chambray", "chamois", "chamoisee",
			"champagne", "chantilly", "charade", "charcoal", "chardon",
			"chardonnay", "charleston green", "charlotte", "charm", "charm pink",
			"chartreuse", "chateau green", "chatelle", "chathams blue", "chelsea cucumber",
			"chelsea gem", "chenin", "cherokee", "cherry blossom pink", "cherry pie",
			"cherrywood", "cherub", "chestnut", "chetwode blue", "chicago",
			"chiffon", "chilean fire", "chilean heath", "china ivory", "china rose",
			"chinese red", "chinese violet", "chino", "chinook", "chlorophyll green",
			"chocolate", "christalle", "christi", "christine", "chrome white",
			"chrome yellow", "cinder", "cinderella", "cinereous", "cinnabar",
			"cinnamon satin", "cioccolato", "citrine", "citrine white", "citron",
			"citrus", "clairvoyant", "clam shell", "claret", "classic rose",
			"clay ash", "clay creek", "clear day", "clementine", "clinker",
			"cloud", "cloud burst", "cloudy", "clover", "cobalt blue",
			"cocoa bean", "cocoa brown", "coconut", "coconut cream", "cod gray",
			"coffee", "coffee bean", "cognac", "cola", "cold purple",
			"cold turkey", "colonial white", "columbia blue", "comet", "como",
			"conch", "concord", "concrete", "confetti", "congo brown",
			"congo pink", "congress blue", "conifer", "contessa", "cool black",
			"cool grey", "copper", "copper canyon", "copper penny", "copper red",
			"copper rose", "copper rust", "coquelicot", "coral", "coral red",
			"coral reef", "coral tree", "cordovan", "corduroy", "coriander",
			"cork", "corn", "corn field", "corn harvest", "cornflower blue",
			"cornflower lilac", "cornsilk", "corvette", "cosmic", "cosmic cobalt",
			"cosmic latte", "cosmos", "costa del sol", "cotton candy", "cotton seed",
			"county green", "cowboy", "coyote brown", "crail", "cranberry",
			"crater brown", "crayola blue", "crayola green", "crayola orange", "crayola red",
			"crayola yellow", "cream", "cream brulee", "cream can", "creole",
			"crete", "crimson", "crimson glory", "crimson red", "crocodile",
			"crown of thorns", "crowshead", "cruise", "crusoe", "crusta",
			"cumin", "cumulus", "cupid", "curious blue", "cutty sark",
			"cyan", "cyan azure", "cyan blue azure", "cyan cobalt blue", "cyan cornflower blue",
			"cyber grape", "cyber yellow", "cyclamen", "cyprus", "daffodil",
			"daintree", "dairy cream", "daisy bush", "dallas", "dandelion",
			"danube", "dark blue", "dark blue gray", "dark brown", "dark brown tangelo",
			"dark burgundy", "dark byzantium", "dark candy apple red", "dark cerulean", "dark chestnut",
			"dark coral", "dark cyan", "dark ebony", "dark fern", "dark goldenrod",
			"dark green", "dark gunmetal", "dark imperial blue", "dark jungle green", "dark khaki",
			"dark lavender", "dark liver", "dark magenta", "dark medium gray", "dark midnight blue",
			"dark moss green", "dark olive green", "dark orange", "dark orchid", "dark pastel blue",
			"dark pastel green", "dark pastel purple", "dark pastel red", "dark pink", "dark puce",
			"dark purple", "dark raspberry", "dark red", "dark salmon", "dark scarlet",
			"dark sea green", "dark sienna", "dark sky blue", "dark slate blue", "dark slate gray",
			"dark spring green", "dark tan", "dark tangerine", "dark terra cotta", "dark turquoise",
			"dark vanilla", "dark violet", "dark yellow", "dartmouth green", "davys grey",
			"dawn", "dawn pink", "de york", "debian red", "deco",
			"deep blue", "deep blush", "deep bronze", "deep carmine", "deep carmine pink",
			"deep carrot orange", "deep cerise", "deep chestnut", "deep cove", "deep fir",
			"deep forest green", "deep fuchsia", "deep green", "deep green cyan turquoise", "deep jungle green",
			"deep koamaru", "deep lemon", "deep lilac", "deep magenta", "deep maroon",
			"deep oak", "deep pink", "deep puce", "deep red", "deep ruby",
			"deep saffron", "deep sapphire", "deep sea", "deep sea green", "deep space sparkle",
			"deep taupe", "deep teal", "deep tuscan red", "deep violet", "deer",
			"del rio", "dell", "delta", "deluge", "denim",
			"denim blue", "derby", "desaturated cyan", "desert", "desert sand",
			"desert storm", "desire", "dew", "di serria", "diamond",
			"diesel", "dim gray", "dingley", "dingy dungeon", "dirt",
			"disco", "dixie", "dodger blue", "dogs", "dogwood rose",
			"dollar bill", "dolly", "dolphin", "domino", "don juan",
			"donkey brown", "dorado", "double colonial white", "double pearl lusta", "double spanish white",
			"dove gray", "downriver", "downy", "driftwood", "drover",
			"duke blue", "dull lavender", "dune", "dust storm", "dusty gray",
			"dutch white", "eagle", "eagle green", "earls green", "early dawn",
			"earth yellow", "east bay", "east side", "eastern blue", "ebb",
			"ebony", "ebony clay", "eclipse", "ecru", "ecru white",
			"ecstasy", "eden", "edgewater", "edward", "eerie black",
			"egg sour", "egg white", "eggplant", "eggshell", "egyptian blue",
			"el paso", "el salva", "electric blue", "electric crimson", "electric indigo",
			"electric lime", "electric purple", "electric violet", "electric yellow", "elephant",
			"elf green", "elm", "emerald", "eminence", "emperor",
			"empress", "endeavour", "energy yellow", "engineering international orange", "english holly",
			"english lavender", "english red", "english vermillion", "english walnut", "envy",
			"equator", "espresso", "eternity", "eton blue", "eucalyptus",
			"eunry", "evening sea", "everglade", "fogra29 rich black", "fogra39 rich black",
			"faded jade", "fair pink", "falcon", "fallow", "falu red",
			"fandango", "fandango pink", "fantasy", "fashion fuchsia", "fawn",
			"fedora", "feijoa", "feldgrau", "fern", "fern frond",
			"fern green", "ferra", "ferrari red", "festival", "feta",
			"field drab", "fiery orange", "fiery rose", "finch", "finlandia",
			"finn", "fiord", "fire", "fire bush", "fire engine red",
			"firebrick", "firefly", "flame", "flame pea", "flamenco",
			"flamingo", "flamingo pink", "flavescent", "flax", "flax smoke",
			"flint", "flirt", "floral white", "flush mahogany", "foam",
			"fog", "foggy gray", "folly", "forest green", "forget me not",
			"fountain blue", "frangipani", "french bistre", "french blue", "french fuchsia",
			"french gray", "french lilac", "french lime", "french mauve", "french pass",
			"french pink", "french plum", "french puce", "french raspberry", "french rose",
			"french sky blue", "french violet", "french wine", "fresh air", "fresh eggplant",
			"friar gray", "fringy flower", "froly", "frost", "frostbite",
			"frosted mint", "frostee", "fruit salad", "fuchsia", "fuchsia blue",
			"fuchsia pink", "fuchsia purple", "fuchsia rose", "fuego", "fuel yellow",
			"fulvous", "fun blue", "fun green", "fuscous gray", "fuzzy wuzzy",
			"fuzzy wuzzy brown", "go green", "gable green", "gainsboro", "gallery",
			"galliano", "gamboge", "gamboge orange", "gargoyle gas", "geebung",
			"generic viridian", "genoa", "geraldine", "geyser", "ghost",
			"ghost white", "giants club", "giants orange", "gigas", "gimblet",
			"gin", "gin fizz", "ginger", "givry", "glacier",
			"glade green", "glaucous", "glitter", "glossy grape", "go ben",
			"goblin", "gold drop", "gold fusion", "gold tips", "golden",
			"golden bell", "golden brown", "golden dream", "golden fizz", "golden gate bridge",
			"golden glow", "golden poppy", "golden sand", "golden tainoi", "golden yellow",
			"goldenrod", "gondola", "gordons green", "gorse", "gossamer",
			"gossip", "gothic", "governor bay", "grain brown", "grandis",
			"granite gray", "granite green", "granny apple", "granny smith", "granny smith apple",
			"grape", "graphite", "gravel", "gray", "gray asparagus",
			"gray chateau", "gray nickel", "gray nurse", "gray olive", "gray suit",
			"green", "green blue", "green cyan", "green haze", "green house",
			"green kelp", "green leaf", "green lizard", "green mist", "green pea",
			"green sheen", "green smoke", "green spring", "green vogue", "green waterloo",
			"green white", "green yellow", "grenadier", "grizzly", "grullo",
			"guardsman red", "gulf blue", "gulf stream", "gull gray", "gum leaf",
			"gumbo", "gun powder", "gunmetal", "gunsmoke", "gurkha",
			"hacienda", "hairy heath", "haiti", "halayà Úbe", "half baked",
			"half colonial white", "half dutch white", "half spanish white", "half and half", "hampton",
			"han blue", "han purple", "harlequin", "harlequin green", "harp",
			"harvard crimson", "harvest gold", "havelock blue", "hawaiian tan", "hawkes blue",
			"heat wave", "heath", "heather", "heathered gray", "heavy metal",
			"heliotrope", "heliotrope gray", "heliotrope magenta", "hemlock", "hemp",
			"hibiscus", "highland", "hillary", "himalaya", "hint of green",
			"hint of red", "hint of yellow", "hippie blue", "hippie green", "hippie pink",
			"hit gray", "hit pink", "hokey pokey", "hoki", "holly",
			"honey flower", "honeydew", "honeysuckle", "honolulu blue", "hookers green",
			"hopbush", "horizon", "horses", "horses neck", "hot magenta",
			"hot pink", "hot toddy", "humming bird", "hunter green", "hurricane",
			"husk", "ice cold", "iceberg", "icterine", "illuminating emerald",
			"illusion", "imperial", "imperial blue", "imperial red", "inch worm",
			"inchworm", "independence", "india green", "indian red", "indian tan",
			"indian yellow", "indigo", "indigo dye", "indochine", "international klein blue",
			"international orange", "iris", "irish coffee", "iroko", "iron",
			"ironside gray", "ironstone", "irresistible", "isabelline", "islamic green",
			"island spice", "ivory", "jacaranda", "jacarta", "jacko bean",
			"jacksons purple", "jade", "jaffa", "jagged ice", "jagger",
			"jaguar", "jambalaya", "janna", "japanese carmine", "japanese indigo",
			"japanese laurel", "japanese maple", "japanese violet", "japonica", "jasmine",
			"jasper", "java", "jazzberry jam", "jelly bean", "jet",
			"jet stream", "jewel", "jon", "jonquil", "jordy blue",
			"judge gray", "jumbo", "june bud", "jungle green", "jungle mist",
			"juniper", "just right", "ku crimson", "kabul", "kaitoke green",
			"kangaroo", "karaka", "karry", "kashmir blue", "kelly green",
			"kelp", "kenyan copper", "keppel", "key lime", "key lime pie",
			"khaki", "kidnapper", "kilamanjaro", "killarney", "kimberly",
			"kingfisher daisy", "kobi", "kobicha", "kokoda", "kombu green",
			"korma", "koromiko", "kournikova", "kumera", "la palma",
			"la rioja", "la salle green", "languid lavender", "lapis lazuli", "las palmas",
			"laser", "laurel", "laurel green", "lava", "lavender",
			"lavender blush", "lavender gray", "lavender indigo", "lavender magenta", "lavender mist",
			"lavender pink", "lavender purple", "lavender rose", "lawn green", "leather",
			"lemon", "lemon chiffon", "lemon curry", "lemon ginger", "lemon glacier",
			"lemon grass", "lemon lime", "lemon meringue", "lemon yellow", "lenurple",
			"liberty", "licorice", "light apricot", "light blue", "light brilliant red",
			"light brown", "light carmine pink", "light cobalt blue", "light coral", "light cornflower blue",
			...
			"light khaki", "light medium orchid", "light moss green", "light orchid", "light pastel purple",
			"light pink", "light salmon", "light salmon pink", "light sea green", "light sky blue",
			"light slate gray", "light steel blue", "light taupe", "light turquoise", "light yellow",
			"lightning yellow", "lilac", "lilac bush", "lilac luster", "lily",
			"lily white", "lima", "lime", "lime green", "limeade",
			"limed ash", "limed oak", "limed spruce", "limerick", "lincoln green",
			"linen", "link water", "lipstick", "lisbon brown", "little boy blue",
			"liver", "liver chestnut", "livid brown", "loafer", "loblolly",
			"lochinvar", "lochmara", "locust", "log cabin", "logan",
			"lola", "london hue", "lonestar", "lotus", "loulou",
			"lucky", "lucky point", "lumber", "lunar green", "lust",
			"luxor gold", "lynch", "msu green", "mabel", "macaroni and cheese",
			"macaroni and cheese", "madang", "madison", "madras", "magenta",
			"magenta haze", "magenta pink", "magic mint", "magic potion", "magnolia",
			"mahogany", "mai tai", "maize", "majorelle blue", "makara",
			"mako", "malachite", "malibu", "mallard", "malta",
			"mamba", "manatee", "mandalay", "mandarin", "mandy",
			"mandys pink", "mango tango", "manhattan", "mantis", "mantle",
			"manz", "mardi gras", "marigold", "marigold yellow", "mariner",
			"maroon", "maroon oak", "marshland", "martini", "martinique",
			"marzipan", "masala", "matisse", "matrix", "matterhorn",
			"mauve", "mauve taupe", "mauvelous", "maverick", "maximum blue",
			"maximum yellow", "may green", "maya blue", "meat brown", "medium aquamarine",
			...
			"melanie", "melanzane", "mellow apricot", "melon", "melrose",
			"mercury", "merino", "merlin", "merlot", "metal pink",
			"metallic bronze", "metallic copper", "metallic gold", "metallic seaweed", "metallic sunburst",
			"meteor", "meteorite", "mexican pink", "mexican red", "mid gray",
			"midnight", "midnight blue", "midnight moss", "mikado", "mikado yellow",
			"milan", "milano red", "milk punch", "millbrook", "mimosa",
			"mindaro", "mine shaft", "mineral green", "ming", "minion yellow",
			"minsk", "mint", "mint cream", "mint green", "mint julep",
			"mint tulip", "mirage", "mischka", "mist gray", "misty moss",
			"misty rose", "mobster", "moccaccino", "moccasin", "mocha",
			"mojo", "mona lisa", "monarch", "mondo", "mongoose",
			"monsoon", "monte carlo", "monza", "moody blue", "moon glow",
			"moon mist", "moon raker", "moonstone blue", "mordant red", "morning glory",
			"morocco brown", "mortar", "mosque", "moss green", "mountain meadow",
			"mountain mist", "mountbatten pink", "muddy waters", "muesli", "mughal green",
			"mulberry", "mulberry wood", "mule fawn", "mulled wine", "mummys tomb",
			"munsell blue", "munsell green", "munsell purple", "munsell red", "munsell yellow",
			"mustard", "my pink", "my sin", "myrtle green", "mystic",
			"mystic maroon", "ncs blue", "ncs green", "ncs red", "nadeshiko pink",
			"nandor", "napa", "napier green", "naples yellow", "narvik",
			"natural gray", "navajo white", "navy", "nebula", "negroni",
			"neon carrot", "neon fuchsia", "neon green", "nepal", "neptune",
			"nero", "nevada", "new car", "new orleans", "new york pink",
			"niagara", "nickel", "night rider", "night shadz", "nile blue",
			"nobel", "nomad", "non photo blue", "north texas green", "norway",
			"nugget", "nutmeg", "nutmeg wood finish", "nyanza", "oasis",
			"observatory", "ocean blue", "ocean boat blue", "ocean green", "ochre",
			"off green", "off yellow", "ogre odor", "oil", "old brick",
			"old burgundy", "old copper", "old gold", "old heliotrope", "old lace",
			"old lavender", "old moss green", "old rose", "old silver", "olive",
			"olive drab", "olive drab seven", "olive green", "olive haze", "olivetone",
			"olivine", "onahau", "onion", "onyx", "opal",
			"opera mauve", "opium", "oracle", "orange", "orange peel",
			"orange red", "orange roughy", "orange soda", "orange white", "orange yellow",
			"orchid", "orchid pink", "orchid white", "oregon", "organ",
			"orient", "oriental pink", "orinoco", "orioles orange", "oslo gray",
			"ottoman", "outer space", "outrageous orange", "oxford blue", "oxley",
			"oyster bay", "oyster pink", "paarl", "pablo", "pacific blue",
			"pacifika", "paco", "padua", "pakistan green", "palatinate blue",
			"palatinate purple", "pale brown", "pale canary", "pale carmine", "pale cerulean",
			"pale chestnut", "pale copper", "pale cornflower blue", "pale cyan", "pale gold",
			"pale goldenrod", "pale green", "pale lavender", "pale leaf", "pale magenta",
			"pale magenta pink", "pale oyster", "pale pink", "pale plum", "pale prim",
			"pale red violet", "pale robin egg blue", "pale rose", "pale silver", "pale sky",
			"pale slate", "pale spring bud", "pale taupe", "pale violet", "palm green",
			"palm leaf", "pampas", "panache", "pancho", "pansy purple",
			"pantone blue", "pantone green", "pantone magenta", "pantone orange", "pantone pink",
			"pantone yellow", "paolo veronese green", "papaya whip", "paprika", "paradise pink",
			"paradiso", "parchment", "paris daisy", "paris m", "paris white",
			"parsley", "pastel blue", "pastel brown", "pastel gray", "pastel green",
			"pastel magenta", "pastel orange", "pastel pink", "pastel purple", "pastel red",
			"pastel violet", "pastel yellow", "patina", "pattens blue", "paua",
			"pavlova", "paynes grey", "peach", "peach cream", "peach orange",
			"peach puff", "peach schnapps", "peach yellow", "peanut", "pear",
			"pearl", "pearl aqua", "pearl bush", "pearl lusta", "pearl mystic turquoise",
			"pearly purple", "peat", "pelorous", "peppermint", "perano",
			"perfume", "peridot", "periglacial blue", "periwinkle", "periwinkle gray",
			"permanent geranium lake", "persian blue", "persian green", "persian indigo", "persian orange",
			"persian pink", "persian plum", "persian red", "persian rose", "persimmon",
			"peru", "peru tan", "pesto", "petite orchid", "pewter",
			"pewter blue", "pharlap", "phthalo blue", "phthalo green", "picasso",
			"pickled bean", "pickled bluewood", "picton blue", "pictorial carmine", "pig pink",
			"pigeon post", "piggy pink", "pigment blue", "pigment green", "pigment red",
			"pine cone", "pine glade", "pine green", "pine tree", "pink",
			"pink flamingo", "pink flare", "pink lace", "pink lady", "pink lavender",
			"pink orange", "pink pearl", "pink raspberry", "pink sherbet", "pink swan",
			"piper", "pipi", "pippin", "pirate gold", "pistachio",
			"pixie green", "pixie powder", "pizazz", "pizza", "plantation",
			"platinum", "plum", "plump purple", "pohutukawa", "polar",
			"polished pine", "polo blue", "pomegranate", "pompadour", "popstar",
			"porcelain", "porsche", "port gore", "portafino", "portage",
			"portica", "portland orange", "pot pourri", "potters clay", "powder ash",
			"powder blue", "prairie sand", "prelude", "prim", "primrose",
			"princess perfume", "princeton orange", "process cyan", "process magenta", "provincial pink",
			"prussian blue", "psychedelic purple", "puce", "pueblo", "puerto rico",
			"pullman brown", "pullman green", "pumice", "pumpkin", "pumpkin skin",
			"punch", "punga", "purple", "purple heart", "purple mountain majesty",
			"purple navy", "purple pizzazz", "purple plum", "purple taupe", "purpureus",
			"putty", "quarter pearl lusta", "quarter spanish white", "quartz", "queen blue",
			"queen pink", "quick silver", "quicksand", "quill gray", "quinacridone magenta",
			"quincy", "ryb blue", "ryb green", "ryb orange", "ryb red",
			"ryb violet", "ryb yellow", "racing green", "radical red", "raffia",
			"rainee", "raisin black", "rajah", "rangitoto", "rangoon green",
			"raspberry", "raspberry pink", "raven", "raw sienna", "raw umber",
			"razzle dazzle rose", "razzmatazz", "razzmic berry", "rebecca purple", "rebel",
			"red", "red beech", "red berry", "red damask", "red devil",
			"red orange", "red oxide", "red purple", "red ribbon", "red robin",
			"red salsa", "red stage", "red violet", "redwood", "reef",
			"reef gold", "regal blue", "regalia", "regent gray", "regent st blue",
			"remy", "reno sand", "resolution blue", "revolver", "rhino",
			"rhythm", "rice cake", "rice flower", "rich black", "rich brilliant lavender",
			"rich carmine", "rich electric blue", "rich gold", "rich lavender", "rich lilac",
			"rich maroon", "rifle green", "rio grande", "ripe lemon", "ripe plum",
			"riptide", "river bed", "roast coffee", "rob roy", "robin egg blue",
			"rock", "rock blue", "rock spray", "rocket metallic", "rodeo dust",
			"rolling stone", "roman", "roman coffee", "roman silver", "romance",
			"romantic", "ronchi", "roof terracotta", "rope", "rose",
			"rose bonbon", "rose bud", "rose bud cherry", "rose dust", "rose ebony",
			"rose fog", "rose gold", "rose pink", "rose red", "rose taupe",
			"rose vale", "rose white", "rose of sharon", "rosewood", "rosso corsa",
			"rosy brown", "roti", "rouge", "royal air force blue", "royal azure",
			"royal blue", "royal fuchsia", "royal heath", "royal purple", "ruber",
			"rubine red", "ruby", "ruby red", "ruddy", "ruddy brown",
			"ruddy pink", "rufous", "rum", "rum swizzle", "russet",
			"russett", "russian green", "russian violet", "rust", "rustic red",
			"rusty nail", "rusty red", "sae ece amber", "sacramento state green", "saddle",
			"saddle brown", "safety orange", "safety yellow", "saffron", "saffron mango",
			"sage", "sahara", "sahara sand", "sail", "salem",
			"salmon", "salmon pink", "salomie", "salt box", "saltpan",
			"sambuca", "san felix", "san juan", "san marino", "sand dune",
			"sandal", "sandrift", "sandstone", "sandstorm", "sandwisp",
			"sandy beach", "sandy brown", "sangria", "sanguine brown", "santa fe",
			"santas gray", "sap green", "sapling", "sapphire", "sapphire blue",
			"saratoga", "sasquatch socks", "satin linen", "satin sheen gold", "sauvignon",
			"sazerac", "scampi", "scandal", "scarlet", "scarlet gum",
			"scarlett", "scarpa flow", "schist", "school bus yellow", "schooner",
			"science blue", "scooter", "scorpion", "scotch mist", "screamin green",
			"sea blue", "sea buckthorn", "sea green", "sea mist", "sea nymph",
			"sea pink", "sea serpent", "seagull", "seal brown", "seance",
			"seashell", "seaweed", "selago", "selective yellow", "sepia",
			"sepia black", "sepia skin", "serenade", "shadow", "shadow blue",
			"shadow green", "shady lady", "shakespeare", "shalimar", "shampoo",
			"shamrock", "shamrock green", "shark", "sheen green", "sherpa blue",
			"sherwood green", "shilo", "shimmering blush", "shingle fawn", "shiny shamrock",
			"ship cove", "ship gray", "shiraz", "shocking", "shocking pink",
			"shuttle gray", "siam", "sidecar", "sienna", "silk",
			"silver", "silver chalice", "silver lake blue", "silver pink", "silver sand",
			"silver tree", "sinbad", "sinopia", "siren", "sirocco",
			"sisal", "sizzling red", "sizzling sunrise", "skeptic", "skobeloff",
			"sky blue", "sky magenta", "slate blue", "slate gray", "slimy green",
			"smalt", "smalt blue", "smashed pumpkin", "smitten", "smoke",
			"smokey topaz", "smoky", "smoky black", "smoky topaz", "snow",
			"snow drift", "snow flurry", "snowy mint", "snuff", "soap",
			"soapstone", "soft amber", "soft peach", "solid pink", "solitaire",
			"solitude", "sonic silver", "sorbus", "sorrell brown", "soya bean",
			"space cadet", "spanish bistre", "spanish blue", "spanish carmine", "spanish crimson",
			"spanish gray", "spanish green", "spanish orange", "spanish pink", "spanish red",
			"spanish sky blue", "spanish violet", "spanish viridian", "spartan crimson", "spectra",
			"spice", "spicy mix", "spicy mustard", "spicy pink", "spindle",
			"spiro disco ball", "spray", "spring bud", "spring frost", "spring green",
			"spring leaves", "spring rain", "spring sun", "spring wood", "sprout",
			"spun pearl", "squirrel", "st patricks blue", "st tropaz", "stack",
			"star command blue", "star dust", "stark white", "starship", "steel blue",
			"steel gray", "steel pink", "steel teal", "stiletto", "stonewall",
			"storm dust", "storm gray", "stormcloud", "stratos", "straw",
			"strawberry", "strikemaster", "stromboli", "studio", "submarine",
			"sugar cane", "sugar plum", "sulu", "summer green", "sun",
			"sunburnt cyclops", "sundance", "sundown", "sunflower", "sunglo",
			"sunglow", "sunny", "sunray", "sunset", "sunset orange",
			"sunshade", "super pink", "supernova", "surf", "surf crest",
			"surfie green", "sushi", "suva gray", "swamp", "swamp green",
			"swans down", "sweet brown", "sweet corn", "sweet pink", "swirl",
			"swiss coffee", "sycamore", "tabasco", "tacao", "tacha",
			"tahiti gold", "tahuna sands", "tall poppy", "tallow", "tamarillo",
			"tamarind", "tan", "tan hide", "tana", "tangaroa",
			"tangelo", "tangerine", "tangerine yellow", "tango", "tango pink",
			"tapa", "tapestry", "tara", "tarawera", "tart orange",
			"tasman", "taupe", "taupe gray", "tawny port", "te papa green",
			"tea", "tea green", "tea rose", "teak", "teal",
			"teal blue", "teal deer", "teal green", "telemagenta", "temptress",
			"tenne", "tequila", "terra cotta", "texas", "texas rose",
			"thatch", "thatch green", "thistle", "thistle green", "thulian pink",
			"thunder", "thunderbird", "tia maria", "tiara", "tiber",
			"tickle me pink", "tidal", "tide", "tiffany blue", "tigers eye",
			"timber green", "timberwolf", "titan white", "titanium yellow", "toast",
			"tobacco brown", "toledo", "tolopea", "tom thumb", "tomato",
			"tonys pink", "toolbox", "topaz", "torea bay", "tory blue",
			"tosca", "totem pole", "tower gray", "tractor red", "tradewind",
			"tranquil", "travertine", "tree poppy", "treehouse", "trendy green",
			"trendy pink", "trinidad", "tropical blue", "tropical rain forest", "tropical violet",
			"trout", "true blue", "true v", "tuatara", "tuft bush",
			"tufts blue", "tulip", "tulip tree", "tumbleweed", "tuna",
			"tundora", "turbo", "turkish rose", "turmeric", "turquoise",
			"turquoise blue", "turquoise green", "turtle green", "tuscan red", "tuscan tan",
			"tuscany", "tusk", "tussock", "tutu", "twilight",
			"twilight blue", "twilight lavender", "twine", "tyrian purple", "ua blue",
			"ua red", "ucla blue", "ucla gold", "ufo green", "up forest green",
			"up maroon", "usafa blue", "ube", "ultra pink", "ultramarine",
			"ultramarine blue", "umber", "unbleached silk", "underage pink", "united nations blue",
			"university of california gold", "university of tennessee orange", "unmellow yellow", "upsdell red", "urobilin",
			"utah crimson", "valencia", "valentino", "valhalla", "van cleef",
			"van dyke brown", "vanilla", "vanilla ice", "varden", "vegas gold",
			"venetian red", "venice blue", "venus", "verdigris", "verdun green",
			"vermilion", "veronica", "very light azure", "very light blue", "very light malachite green",
			"very light tangelo", "very pale orange", "very pale yellow", "vesuvius", "victoria",
			"vida loca", "viking", "vin rouge", "viola", "violent violet",
			"violet", "violet blue", "violet eggplant", "violet red", "viridian",
			"viridian green", "vis vis", "vista blue", "vista white", "vivid amber",
			"vivid auburn", "vivid burgundy", "vivid cerise", "vivid cerulean", "vivid crimson",
			...
			"vivid sky blue", "vivid tangelo", "vivid tangerine", "vivid vermilion", "vivid violet",
			"vivid yellow", "volt", "voodoo", "vulcan", "wafer",
			"waikawa gray", "waiouru", "walnut", "warm black", "wasabi",
			"water leaf", "watercourse", "waterloo ", "waterspout", "wattle",
			"watusi", "wax flower", "we peep", "web chartreuse", "web orange",
			"wedgewood", "weldon blue", "well read", "wenge", "west coast",
			"west side", "westar", "wewak", "wheat", "wheatfield",
			"whiskey", "whisper", "white", "white ice", "white lilac",
			"white linen", "white pointer", "white rock", "white smoke", "wild blue yonder",
			"wild orchid", "wild rice", "wild sand", "wild strawberry", "wild watermelon",
			"wild willow", "william", "willow brook", "willow grove", "willpower orange",
			"windsor", "windsor tan", "wine", "wine berry", "wine dregs",
			"winter hazel", "winter sky", "winter wizard", "wintergreen dream", "wisp pink",
			"wisteria", "wistful", "witch haze", "wood bark", "woodland",
			"woodrush", "woodsmoke", "woody brown", "x11 dark green", "x11 gray",
			"xanadu", "yale blue", "yankees blue", "yellow", "yellow green",
			"yellow metal", "yellow orange", "yellow rose", "yellow sea", "your pink",
			"yukon gold", "yuma", "zaffre", "zambezi", "zanah",
			"zest", "zeus", "ziggurat", "zinnwaldite", "zinnwaldite brown",
			"zircon", "zombie", "zomp", "zorba", "zuccini",
			"zumthor"
		];
